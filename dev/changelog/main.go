...
var program = &cobra.Command{
	Use:   "changelog",
	Long:  "Little configurable CLI to update the markdown for your changelogs from release-note blocks found into your project pull requests.",
...
func init() {
	...
	flags.StringVarP(&opts.Branch, "branch", "b", "main", "the target branch you want to filter by the pull requests")
	flags.StringVarP(&opts.ChangelogFile, "file", "f", "CHANGELOG.md", "the changelog file")
...
func GetReleaseNotes(c *github.Client, opts *Options, lastPrNr int) ([]ReleaseNote, error) {
	var (
...
func GetAuthors(c *github.Client, ctx context.Context, opts *Options, prNum int) (map[string]Author, error) {
