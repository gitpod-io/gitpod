...
mysql -u "$DB_USERNAME" -h 127.0.0.1 -P 33306 -p"$DB_PASSWORD" gitpod -e "INSERT INTO d_b_team (id, name, slug, creationTime, deleted, _lastModified, markedDeleted) VALUES ('de92f9f4-474a-459e-9497-610e11b3e9a6', 'team1', 'team1', '2022-10-06T21:25:00.562Z', '0', '2022-10-06 21:25:00.565828', '0')";
mysql -u "$DB_USERNAME" -h 127.0.0.1 -P 33306 -p"$DB_PASSWORD" gitpod -e "INSERT INTO d_b_team_membership (id, teamId, userId, role, creationTime, deleted, _lastModified, subscriptionId) VALUES ('00000000-0000-0000-0000-444444444444', 'de92f9f4-474a-459e-9497-610e11b3e9a6', '$USER_ID', 'owner', '2022-10-06T21:25:00.562Z', '0', '2022-10-07 10:57:32.992862', 'b33ad778-2f12-429a-9f35-9aa5e275df3d')";
mysql -u "$DB_USERNAME" -h 127.0.0.1 -P 33306 -p"$DB_PASSWORD" gitpod -e "INSERT INTO d_b_team_subscription2 (id, teamId, paymentReference, startDate, endDate, planId, quantity, cancellationDate, deleted, _lastModified, excludeFromMoreResources) VALUES ('00000000-0000-0000-0000-555555555555', 'de92f9f4-474a-459e-9497-610e11b3e9a6', 'fake-ts2-payment-ref', '2022-10-07T10:57:23.000Z', '', 'team-professional-eur', '1', '', '0', '2022-10-07 10:57:32.946359', '1')";
