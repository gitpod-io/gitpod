  ...
  @test public async tokenResourceGuardCanAccess() {
    ...
    const tests: {
      ...
      },
      {
        ...
        guard: new TokenResourceGuard(workspaceResource.subject.ownerId, [
          'resource:' +
            ScopedResourceGuard.marshalResourceScope({ kind: 'workspace', subjectID: '*', operations: ['get'] }),
        ]),
        expectation: true,
      },
      {
        ...
        guard: new TokenResourceGuard(workspaceResource.subject.ownerId, [
          'resource:' +
            ScopedResourceGuard.marshalResourceScope({
              kind: 'snapshot',
              subjectID: ScopedResourceGuard.SNAPSHOT_WORKSPACE_SUBJECT_ID_PREFIX + workspaceResource.subject.id,
              operations: ['create'],
            }),
        ]),
        resource: {
          kind: 'snapshot',
          subject: undefined,
          workspaceID: workspaceResource.subject.id,
          workspaceOwnerID: workspaceResource.subject.ownerId,
        },
        operation: 'create',
        expectation: true,
      },
