...
func request_TaskService_GetOutput_0(ctx context.Context, marshaler runtime.Marshaler, client TaskServiceClient, req *http.Request, pathParams map[string]string) (TaskService_GetOutputClient, runtime.ServerMetadata, error) {
...
func RegisterTaskServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TaskServiceServer) error {
	...
	mux.Handle("GET", pattern_TaskService_GetOutput_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterTaskServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TaskServiceClient) error {
	...
	mux.Handle("GET", pattern_TaskService_GetOutput_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/supervisor.TaskService/GetOutput", runtime.WithHTTPPathPattern("/v1/terminal/get/{task_id}/output"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_TaskService_GetOutput_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		...
		forward_TaskService_GetOutput_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_TaskService_GetOutput_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"v1", "terminal", "get", "task_id", "output"}, ""))
)

var (
	forward_TaskService_GetOutput_0 = runtime.ForwardResponseStream
)
