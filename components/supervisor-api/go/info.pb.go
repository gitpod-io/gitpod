...
type WorkspaceInfoResponse struct {
	...
	WorkspaceDefaultImage string `protobuf:"bytes,19,opt,name=workspace_default_image,json=workspaceDefaultImage,proto3" json:"workspace_default_image,omitempty"`
}
...
func (x *WorkspaceInfoResponse) GetWorkspaceDefaultImage() string {
	if x != nil {
		return x.WorkspaceDefaultImage
	}
	return ""
}
...
var file_info_proto_rawDesc = []byte{
	...
	0x61, 0x62, 0x6c, 0x65, 0x64, 0x12, 0x36, 0x0a, 0x17, 0x77, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61,
	0x63, 0x65, 0x5f, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x5f, 0x69, 0x6d, 0x61, 0x67, 0x65,
	0x18, 0x13, 0x20, 0x01, 0x28, 0x09, 0x52, 0x15, 0x77, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63,
	0x65, 0x44, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x1a, 0x3b, 0x0a,
