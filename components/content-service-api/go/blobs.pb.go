...
func (x *DownloadRequest) GetOwnerId() string {
	if x != nil {
		return x.OwnerId
	}
	return ""
...
func (x *DownloadRequest) GetContentType() string {
	if x != nil {
...
func (x *DeleteRequest) Reset() {
	*x = DeleteRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_blobs_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteRequest) Descriptor() ([]byte, []int) {
	return file_blobs_proto_rawDescGZIP(), []int{6}
}
...
func (x *DeleteResponse) Reset() {
	*x = DeleteResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_blobs_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteResponse) Descriptor() ([]byte, []int) {
	return file_blobs_proto_rawDescGZIP(), []int{7}
}
...
var file_blobs_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0x8f, 0x01,
	...
	0x2c, 0x0a, 0x10, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0x64, 0x0a,
	...
	0x6e, 0x73, 0x65, 0x32, 0xd7, 0x02, 0x0a, 0x0b, 0x42, 0x6c, 0x6f, 0x62, 0x53, 0x65, 0x72, 0x76,
	...
	,
...
var file_blobs_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_blobs_proto_goTypes = []interface{}{
	(*DownloadRequest)(nil),     // 0: contentservice.DownloadRequest
	(*DownloadResponse)(nil),    // 1: contentservice.DownloadResponse
	(*UploadUrlRequest)(nil),    // 2: contentservice.UploadUrlRequest
	(*UploadUrlResponse)(nil),   // 3: contentservice.UploadUrlResponse
	(*DownloadUrlRequest)(nil),  // 4: contentservice.DownloadUrlRequest
	(*DownloadUrlResponse)(nil), // 5: contentservice.DownloadUrlResponse
	(*DeleteRequest)(nil),       // 6: contentservice.DeleteRequest
	(*DeleteResponse)(nil),      // 7: contentservice.DeleteResponse
}
var file_blobs_proto_depIdxs = []int32{
	2, // 0: contentservice.BlobService.UploadUrl:input_type -> contentservice.UploadUrlRequest
	4, // 1: contentservice.BlobService.DownloadUrl:input_type -> contentservice.DownloadUrlRequest
	6, // 2: contentservice.BlobService.Delete:input_type -> contentservice.DeleteRequest
	0, // 3: contentservice.BlobService.Download:input_type -> contentservice.DownloadRequest
	3, // 4: contentservice.BlobService.UploadUrl:output_type -> contentservice.UploadUrlResponse
	5, // 5: contentservice.BlobService.DownloadUrl:output_type -> contentservice.DownloadUrlResponse
	7, // 6: contentservice.BlobService.Delete:output_type -> contentservice.DeleteResponse
	1, // 7: contentservice.BlobService.Download:output_type -> contentservice.DownloadResponse
...
func file_blobs_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_blobs_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_blobs_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
	...
	file_blobs_proto_msgTypes[6].OneofWrappers = []interface{}{
