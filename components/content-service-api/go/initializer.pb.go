...
type PrebuildInitializer struct {
	...
	// Types that are assignable to Spec:
	//	*PrebuildInitializer_Git
	//	*PrebuildInitializer_Composite
	Spec isPrebuildInitializer_Spec `protobuf_oneof:"spec"`
}
...
func (m *PrebuildInitializer) GetSpec() isPrebuildInitializer_Spec {
	if m != nil {
		return m.Spec
	}
	return nil
...
func (x *PrebuildInitializer) GetGit() *GitInitializer {
	if x, ok := x.GetSpec().(*PrebuildInitializer_Git); ok {
		return x.Git
	}
	return nil
}
...
func (x *PrebuildInitializer) GetComposite() *CompositeInitializer {
	if x, ok := x.GetSpec().(*PrebuildInitializer_Composite); ok {
		return x.Composite
	}
	return nil
}

type isPrebuildInitializer_Spec interface {
	isPrebuildInitializer_Spec()
}

type PrebuildInitializer_Git struct {
	Git *GitInitializer `protobuf:"bytes,2,opt,name=git,proto3,oneof"`
}

type PrebuildInitializer_Composite struct {
	Composite *CompositeInitializer `protobuf:"bytes,3,opt,name=composite,proto3,oneof"`
}

func (*PrebuildInitializer_Git) isPrebuildInitializer_Spec() {}

func (*PrebuildInitializer_Composite) isPrebuildInitializer_Spec() {}
...
var file_initializer_proto_rawDesc = []byte{
	...
	0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x22, 0xd8, 0x01, 0x0a, 0x13, 0x50, 0x72, 0x65, 0x62,
	...
	0x12, 0x32, 0x0a, 0x03, 0x67, 0x69, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e,
	...
	0x03, 0x67, 0x69, 0x74, 0x12, 0x44, 0x0a, 0x09, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x69, 0x74,
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e,
	0x74, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x69,
	0x74, 0x65, 0x49, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x72, 0x48, 0x00, 0x52,
	0x09, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x65, 0x42, 0x06, 0x0a, 0x04, 0x73, 0x70,
	0x65, 0x63, 0x22, 0x17, 0x0a, 0x15, 0x46, 0x72, 0x6f, 0x6d, 0x42, 0x61, 0x63, 0x6b, 0x75, 0x70,
...
func file_initializer_proto_init() {
	...
	file_initializer_proto_msgTypes[7].OneofWrappers = []interface{}{
		(*PrebuildInitializer_Git)(nil),
		(*PrebuildInitializer_Composite)(nil),
	}
	type x struct{}
