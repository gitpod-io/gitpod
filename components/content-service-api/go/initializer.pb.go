...
type WorkspaceInitializer struct {
	...
	//	*WorkspaceInitializer_VolumeSnapshot
...
func (x *WorkspaceInitializer) GetVolumeSnapshot() *FromVolumeSnapshotInitializer {
	if x, ok := x.GetSpec().(*WorkspaceInitializer_VolumeSnapshot); ok {
...
type WorkspaceInitializer_VolumeSnapshot struct {
	VolumeSnapshot *FromVolumeSnapshotInitializer `protobuf:"bytes,8,opt,name=volume_snapshot,json=volumeSnapshot,proto3,oneof"`
}
...
func (*WorkspaceInitializer_VolumeSnapshot) isWorkspaceInitializer_Spec() {}
...
type FromVolumeSnapshotInitializer struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *FromVolumeSnapshotInitializer) Reset() {
	*x = FromVolumeSnapshotInitializer{}
	if protoimpl.UnsafeEnabled {
...
func (x *FromVolumeSnapshotInitializer) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FromVolumeSnapshotInitializer) ProtoMessage() {}

func (x *FromVolumeSnapshotInitializer) ProtoReflect() protoreflect.Message {
	mi := &file_initializer_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FromVolumeSnapshotInitializer.ProtoReflect.Descriptor instead.
func (*FromVolumeSnapshotInitializer) Descriptor() ([]byte, []int) {
	return file_initializer_proto_rawDescGZIP(), []int{9}
}

func (x *FromVolumeSnapshotInitializer) GetCheckoutLocation() string {
	if x != nil {
		return x.CheckoutLocation
	}
	return ""
...
var file_initializer_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2d, 0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e,
	0x74, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x46, 0x72, 0x6f, 0x6d, 0x56, 0x6f, 0x6c,
	0x75, 0x6d, 0x65, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x49, 0x6e, 0x69, 0x74, 0x69,
	0x61, 0x6c, 0x69, 0x7a, 0x65, 0x72, 0x48, 0x00, 0x52, 0x0e, 0x76, 0x6f, 0x6c, 0x75, 0x6d, 0x65,
	0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x42, 0x06, 0x0a, 0x04, 0x73, 0x70, 0x65, 0x63,
	...
	0x6f, 0x6e, 0x22, 0x4c, 0x0a, 0x1d, 0x46, 0x72, 0x6f, 0x6d, 0x56, 0x6f, 0x6c, 0x75, 0x6d, 0x65,
...
var file_initializer_proto_goTypes = []interface{}{
	...
	(*FromVolumeSnapshotInitializer)(nil),    // 11: contentservice.FromVolumeSnapshotInitializer
...
var file_initializer_proto_depIdxs = []int32{
	...
	11, // 7: contentservice.WorkspaceInitializer.volume_snapshot:type_name -> contentservice.FromVolumeSnapshotInitializer
...
func file_initializer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_initializer_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FromVolumeSnapshotInitializer); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_initializer_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*WorkspaceInitializer_VolumeSnapshot)(nil),
	}
	type x struct{}
