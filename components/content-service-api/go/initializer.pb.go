...
type FromBackupInitializer struct {
	...
	FromSnapshotVolume bool   `protobuf:"varint,2,opt,name=from_snapshot_volume,json=fromSnapshotVolume,proto3" json:"from_snapshot_volume,omitempty"`
}
...
func (x *FromBackupInitializer) GetFromSnapshotVolume() bool {
	if x != nil {
...
var file_initializer_proto_rawDesc = []byte{
	...
	0x5f, 0x73, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x5f, 0x76, 0x6f, 0x6c, 0x75, 0x6d, 0x65,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x12, 0x66, 0x72, 0x6f, 0x6d, 0x53, 0x6e, 0x61, 0x70,
	0x73, 0x68, 0x6f, 0x74, 0x56, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x22, 0xe7, 0x02, 0x0a, 0x09, 0x47,
