...
goog.exportSymbol('proto.contentservice.FromVolumeSnapshotInitializer', null, global);
 ...
 * @constructor
 */
proto.contentservice.FromVolumeSnapshotInitializer = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.contentservice.FromVolumeSnapshotInitializer, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.contentservice.FromVolumeSnapshotInitializer.displayName = 'proto.contentservice.FromVolumeSnapshotInitializer';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.contentservice.WorkspaceInitializer.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    volumeSnapshot: (f = msg.getVolumeSnapshot()) && proto.contentservice.FromVolumeSnapshotInitializer.toObject(includeInstance, f)
  };
...
proto.contentservice.WorkspaceInitializer.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 7:
      ...
      break;
    case 8:
      var value = new proto.contentservice.FromVolumeSnapshotInitializer;
      reader.readMessage(value,proto.contentservice.FromVolumeSnapshotInitializer.deserializeBinaryFromReader);
...
proto.contentservice.WorkspaceInitializer.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      8,
      f,
      proto.contentservice.FromVolumeSnapshotInitializer.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional FromVolumeSnapshotInitializer volume_snapshot = 8;
 * @return {?proto.contentservice.FromVolumeSnapshotInitializer}
 */
proto.contentservice.WorkspaceInitializer.prototype.getVolumeSnapshot = function() {
  return /** @type{?proto.contentservice.FromVolumeSnapshotInitializer} */ (
    jspb.Message.getWrapperField(this, proto.contentservice.FromVolumeSnapshotInitializer, 8));
};


/**
 * @param {?proto.contentservice.FromVolumeSnapshotInitializer|undefined} value
 * @return {!proto.contentservice.WorkspaceInitializer} returns this
*/
proto.contentservice.WorkspaceInitializer.prototype.setVolumeSnapshot = function(value) {
 ...
 * @return {!proto.contentservice.WorkspaceInitializer} returns this
 */
proto.contentservice.WorkspaceInitializer.prototype.clearVolumeSnapshot = function() {
 ...
 * @return {boolean}
 */
proto.contentservice.WorkspaceInitializer.prototype.hasVolumeSnapshot = function() {
 ...
 * @return {!Object}
 */
proto.contentservice.FromVolumeSnapshotInitializer.prototype.toObject = function(opt_includeInstance) {
  return proto.contentservice.FromVolumeSnapshotInitializer.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.contentservice.FromVolumeSnapshotInitializer} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.contentservice.FromVolumeSnapshotInitializer.toObject = function(includeInstance, msg) {
  var f, obj = {
    checkoutLocation: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * @return {!proto.contentservice.FromVolumeSnapshotInitializer}
 */
proto.contentservice.FromVolumeSnapshotInitializer.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.contentservice.FromVolumeSnapshotInitializer;
  return proto.contentservice.FromVolumeSnapshotInitializer.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.contentservice.FromVolumeSnapshotInitializer} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.contentservice.FromVolumeSnapshotInitializer}
 */
proto.contentservice.FromVolumeSnapshotInitializer.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.contentservice.FromVolumeSnapshotInitializer.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.contentservice.FromVolumeSnapshotInitializer.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.contentservice.FromVolumeSnapshotInitializer} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.contentservice.FromVolumeSnapshotInitializer.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getCheckoutLocation();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.contentservice.FromVolumeSnapshotInitializer.prototype.getCheckoutLocation = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.contentservice.FromVolumeSnapshotInitializer} returns this
 */
proto.contentservice.FromVolumeSnapshotInitializer.prototype.setCheckoutLocation = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
