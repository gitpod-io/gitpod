...
goog.exportSymbol('proto.contentservice.FromSnapshotVolumeInitializer', null, global);
 ...
 * @constructor
 */
proto.contentservice.FromSnapshotVolumeInitializer = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.contentservice.FromSnapshotVolumeInitializer, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.contentservice.FromSnapshotVolumeInitializer.displayName = 'proto.contentservice.FromSnapshotVolumeInitializer';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.contentservice.WorkspaceInitializer.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    snapshotVolume: (f = msg.getSnapshotVolume()) && proto.contentservice.FromSnapshotVolumeInitializer.toObject(includeInstance, f)
  };
...
proto.contentservice.WorkspaceInitializer.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 7:
      ...
      break;
    case 8:
      var value = new proto.contentservice.FromSnapshotVolumeInitializer;
      reader.readMessage(value,proto.contentservice.FromSnapshotVolumeInitializer.deserializeBinaryFromReader);
      msg.setSnapshotVolume(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.contentservice.WorkspaceInitializer.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getSnapshotVolume();
  if (f != null) {
    writer.writeMessage(
      8,
      f,
      proto.contentservice.FromSnapshotVolumeInitializer.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional FromSnapshotVolumeInitializer snapshot_volume = 8;
 * @return {?proto.contentservice.FromSnapshotVolumeInitializer}
 */
proto.contentservice.WorkspaceInitializer.prototype.getSnapshotVolume = function() {
  return /** @type{?proto.contentservice.FromSnapshotVolumeInitializer} */ (
    jspb.Message.getWrapperField(this, proto.contentservice.FromSnapshotVolumeInitializer, 8));
};


/**
 * @param {?proto.contentservice.FromSnapshotVolumeInitializer|undefined} value
 * @return {!proto.contentservice.WorkspaceInitializer} returns this
*/
proto.contentservice.WorkspaceInitializer.prototype.setSnapshotVolume = function(value) {
 ...
 * @return {!proto.contentservice.WorkspaceInitializer} returns this
 */
proto.contentservice.WorkspaceInitializer.prototype.clearSnapshotVolume = function() {
  return this.setSnapshotVolume(undefined);
};
 ...
 * @return {boolean}
 */
proto.contentservice.WorkspaceInitializer.prototype.hasSnapshotVolume = function() {
 ...
 * @return {!Object}
 */
proto.contentservice.FromSnapshotVolumeInitializer.prototype.toObject = function(opt_includeInstance) {
  return proto.contentservice.FromSnapshotVolumeInitializer.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.contentservice.FromSnapshotVolumeInitializer} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.contentservice.FromSnapshotVolumeInitializer.toObject = function(includeInstance, msg) {
  var f, obj = {
    checkoutLocation: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * @return {!proto.contentservice.FromSnapshotVolumeInitializer}
 */
proto.contentservice.FromSnapshotVolumeInitializer.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.contentservice.FromSnapshotVolumeInitializer;
  return proto.contentservice.FromSnapshotVolumeInitializer.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.contentservice.FromSnapshotVolumeInitializer} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.contentservice.FromSnapshotVolumeInitializer}
 */
proto.contentservice.FromSnapshotVolumeInitializer.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.contentservice.FromSnapshotVolumeInitializer.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.contentservice.FromSnapshotVolumeInitializer.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.contentservice.FromSnapshotVolumeInitializer} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.contentservice.FromSnapshotVolumeInitializer.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getCheckoutLocation();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.contentservice.FromSnapshotVolumeInitializer.prototype.getCheckoutLocation = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.contentservice.FromSnapshotVolumeInitializer} returns this
 */
proto.contentservice.FromSnapshotVolumeInitializer.prototype.setCheckoutLocation = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
