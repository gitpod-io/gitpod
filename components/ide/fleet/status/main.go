...
func main() {
	...
	errlog := log.New(os.Stderr, "Fleet status: ", log.LstdFlags)
	...
	http.HandleFunc("/status", func(w http.ResponseWriter, r *http.Request) {
		...
		// jetbrains://fleet/join?version=1.10.192&workspaceId=unah3selk65kk5lt4bgd&session=bxcbGeY3o8gm4_258-AJFpa3wUBdPDhVSjBG94kTFNc
