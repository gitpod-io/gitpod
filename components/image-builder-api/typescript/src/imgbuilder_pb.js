    ...
    proto.builder.BuildRegistryAuth.toObject = function (includeInstance, msg) {
        var f,
            obj = {
                ...
                selective:
                    (f = msg.getSelective()) && proto.builder.BuildRegistryAuthSelective.toObject(includeInstance, f),
            };
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.builder.ListBuildsResponse.toObject = function (includeInstance, msg) {
        var f,
            obj = {
                buildsList: jspb.Message.toObjectList(
                    msg.getBuildsList(),
                    proto.builder.BuildInfo.toObject,
                    includeInstance,
                ),
            };
...
proto.builder.BuildInfo.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(6, f, proto.builder.LogInfo.serializeBinaryToWriter);
    }
};
...
proto.builder.BuildInfo.prototype.getLogInfo = function () {
    return /** @type{?proto.builder.LogInfo} */ (jspb.Message.getWrapperField(this, proto.builder.LogInfo, 6));
};
