...
interface IImageBuilderService_IResolveBaseImage
    extends grpc.MethodDefinition<imgbuilder_pb.ResolveBaseImageRequest, imgbuilder_pb.ResolveBaseImageResponse> {
...
interface IImageBuilderService_IResolveWorkspaceImage
    extends grpc.MethodDefinition<
        imgbuilder_pb.ResolveWorkspaceImageRequest,
        imgbuilder_pb.ResolveWorkspaceImageResponse
    > {
...
interface IImageBuilderService_IBuild
    extends grpc.MethodDefinition<imgbuilder_pb.BuildRequest, imgbuilder_pb.BuildResponse> {
...
interface IImageBuilderService_ILogs
    extends grpc.MethodDefinition<imgbuilder_pb.LogsRequest, imgbuilder_pb.LogsResponse> {
...
interface IImageBuilderService_IListBuilds
    extends grpc.MethodDefinition<imgbuilder_pb.ListBuildsRequest, imgbuilder_pb.ListBuildsResponse> {
...
export interface IImageBuilderServer extends grpc.UntypedServiceImplementation {
    resolveBaseImage: grpc.handleUnaryCall<
        imgbuilder_pb.ResolveBaseImageRequest,
        imgbuilder_pb.ResolveBaseImageResponse
    >;
    resolveWorkspaceImage: grpc.handleUnaryCall<
        imgbuilder_pb.ResolveWorkspaceImageRequest,
        imgbuilder_pb.ResolveWorkspaceImageResponse
    >;
...
export interface IImageBuilderClient {
    resolveBaseImage(
        request: imgbuilder_pb.ResolveBaseImageRequest,
        callback: (error: grpc.ServiceError | null, response: imgbuilder_pb.ResolveBaseImageResponse) => void,
    ...
    resolveWorkspaceImage(
        request: imgbuilder_pb.ResolveWorkspaceImageRequest,
        callback: (error: grpc.ServiceError | null, response: imgbuilder_pb.ResolveWorkspaceImageResponse) => void,
    ): grpc.ClientUnaryCall;
    resolveWorkspaceImage(
        request: imgbuilder_pb.ResolveWorkspaceImageRequest,
        metadata: grpc.Metadata,
    ...
    build(
        request: imgbuilder_pb.BuildRequest,
        options?: Partial<grpc.CallOptions>,
    ): grpc.ClientReadableStream<imgbuilder_pb.BuildResponse>;
    build(
        request: imgbuilder_pb.BuildRequest,
        metadata?: grpc.Metadata,
        options?: Partial<grpc.CallOptions>,
    ...
    logs(
        request: imgbuilder_pb.LogsRequest,
        options?: Partial<grpc.CallOptions>,
    ): grpc.ClientReadableStream<imgbuilder_pb.LogsResponse>;
    logs(
        request: imgbuilder_pb.LogsRequest,
        metadata?: grpc.Metadata,
        options?: Partial<grpc.CallOptions>,
    ...
    listBuilds(
        request: imgbuilder_pb.ListBuildsRequest,
        callback: (error: grpc.ServiceError | null, response: imgbuilder_pb.ListBuildsResponse) => void,
    ): grpc.ClientUnaryCall;
    listBuilds(
        request: imgbuilder_pb.ListBuildsRequest,
        metadata: grpc.Metadata,
