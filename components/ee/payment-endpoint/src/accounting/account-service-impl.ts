...
export class AccountServiceImpl implements AccountService {
  ...
  protected projectSubscriptionsCredits(
    ...
    for (const subscription of subscriptions) {
      ...
      while (billingPeriodStart < endDate && (!subscription.endDate || billingPeriodStart < subscription.endDate)) {
        ...
        const amount =
          firstPeriod && !!subscription.firstMonthAmount ? subscription.firstMonthAmount : subscription.amount;
        creditEntries.push(
          AccountEntry.create({
            userId: userId,
            amount,
