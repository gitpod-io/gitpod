...
describe('Basic unidirectional replication', () => {
  ...
  it('Should replicate everything', async () => {
    ...
    await query(
      source,
      `INSERT INTO names VALUES ("9fa18735-c43b-4651-81c5-ddfbdee1035d", "Bar", "1970-01-01 00:00:01.001", 0)`,
    );
  ...
  it('Should replicate with a start date', async function () {
    ...
    await query(
      source,
      `INSERT INTO names VALUES ("9fa18735-c43b-4651-81c5-ddfbdee1035d", "Bar", "1980-01-01 00:00:01.001", 0)`,
    );
  ...
  it('Should overwrite outdated values and keep newer ones intact', async () => {
    ...
    await query(
      source,
      `INSERT INTO names VALUES ("9fa18735-c43b-4651-81c5-ddfbdee1035d", "Bar Expected", "1980-01-01 00:00:01.001", 0)`,
    );

    await query(
      target,
      `INSERT INTO names VALUES ("9fa18735-c43b-4651-81c5-ddfbdee1035c", "Foo Expected", "1980-01-01 00:00:01.001", 0)`,
    );
    await query(
      target,
      `INSERT INTO names VALUES ("9fa18735-c43b-4651-81c5-ddfbdee1035d", "Bar Old", "1970-01-01 00:00:01.001", 0)`,
    );
  ...
  it('Should pick up from the last replication time', async () => {
    ...
    await query(source, `INSERT INTO names VALUES ("9fa18735-c43b-4651-81c5-ddfbdee1035d", "Bar", ?, 0)`, {
      values: [new Date(lastExport[0].value)],
    });
    await replicator.synchronize(false);
  ...
  it('Should delete entries', async () => {
    ...
    await query(
      source,
      `INSERT INTO names VALUES ("9fa18735-c43b-4651-81c5-ddfbdee1035d", "Bar", "1970-01-02 00:00:01.001", 1)`,
    );
    await query(
      target,
      `INSERT INTO names VALUES ("9fa18735-c43b-4651-81c5-ddfbdee1035c", "Foo", "1970-01-01 00:00:01.001", 0)`,
  ...
  it('Should delete only if entry is older', async () => {
    ...
    await query(
      middle,
      `INSERT INTO names VALUES ("9fa18735-c43b-4651-81c5-ddfbdee1035d", "Changed", "1970-01-03 00:00:01.001", 0)`,
    );
    await query(
      target,
      `INSERT INTO names VALUES ("9fa18735-c43b-4651-81c5-ddfbdee1035c", "Foo", "1970-01-01 00:00:01.001", 0)`,
...
namespace TestTableDescriptionProvider {
  export async function createTables(conn: Connection) {
    await query(
      conn,
      'CREATE TABLE IF NOT EXISTS names (uid CHAR(36) NOT NULL PRIMARY KEY, name char(36) NOT NULL, _lastModified timestamp(3) NOT NULL, _deleted tinyint(4) NOT NULL DEFAULT 0) ENGINE=InnoDB;',
    );
  }
}
