...
import { ICommand, RunCommand, ExportCommand, BumpTimeColumnCommand } from "./commands";
import {
    TableDescriptionProvider,
    GitpodTableDescriptionProvider,
    GitpodSessionTableDescriptionProvider,
} from "@gitpod/gitpod-db/lib/tables";
...
export const productionContainerModule = new ContainerModule((bind, unbind, isBound, rebind) => {
    ...
    bind(ICommand).to(BumpTimeColumnCommand).inSingletonScope();
