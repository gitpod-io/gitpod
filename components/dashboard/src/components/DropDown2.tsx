...
export const DropDown2: FunctionComponent<DropDown2Props> = (props) => {
    ...
    const onKeyDown = useCallback(
        ...
        [filteredOptions, props, selectedElementTemp, showDropDown, toggleDropDown],
    );
    ...
    return (
        <div onKeyDown={onKeyDown} onBlur={handleBlur} tabIndex={0} className="relative flex flex-col">
            <div
                className={
