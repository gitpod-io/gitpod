  ...
  return (
    <>
            ...
            <ItemsList className="app-container pb-40">
              ...
              {inactiveWorkspaces.length > 0 && (
                <div className="p-3 text-gray-400 bg-gray-50 dark:bg-gray-800 rounded-xl text-sm text-center">
                  ...
                  <a className="gp-link" href="https://www.gitpod.io/docs/life-of-workspace/#garbage-collection">
                    Learn more
                  </a>
                </div>
              )}
              ...
              <div className="flex flex-col items-center justify-center h-96 w-96 mx-auto">
                <>
                  ...
                  <div className="text-center pb-6 text-gray-500">
                    Prefix any Git repository URL with {window.location.host}/# or create a new workspace for a recently
                    used project.{' '}
      ...
      <StartWorkspaceModal
        ...
        recent={workspaceModel && activeWorkspaces ? getRecentSuggestions() : []}
      />
    </>
  );
}
