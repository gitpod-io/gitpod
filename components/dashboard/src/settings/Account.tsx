    ...
    <div>
      ...
      >
        <ol className="text-gray-500 text-sm list-outside list-decimal">
          ...
          <li className="ml-5">
            Your subscription will be cancelled. If you obtained a Gitpod subscription through the GitHub marketplace,
            you need to cancel your plan there.
          </li>
        </ol>
      ...
      <PageWithSubMenu subMenu={settingsMenu} title="Account" subtitle="Manage account and Git configuration.">
        ...
        <p className="text-base text-gray-500 pb-4 max-w-2xl">
          The following information will be used to set up Git configuration. You can override Git author name and email
          per project by using the default environment variables <CodeText>GIT_AUTHOR_NAME</CodeText>,{' '}
