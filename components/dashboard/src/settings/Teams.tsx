        ...
        <div className="w-full flex h-80 mt-2 rounded-xl bg-gray-100 dark:bg-gray-900">
          <div className="m-auto text-center">
            ...
            <div className="text-gray-500 mb-6">
              ...
              <a href="https://www.gitpod.io/docs/teams/" target="_blank" rel="noopener" className="gp-link">
                Learn more
              </a>
            </div>
          ...
          {pendingPlanPurchase && (
            ...
            >
              <div className="px-4 self-center w-1/12">
                <div className={'rounded-full w-3 h-3 text-sm align-middle bg-gitpod-kumquat'}>&nbsp;</div>
              </div>
              <div className="p-0 my-auto flex flex-col w-6/12">
                <span className="my-auto font-medium truncate overflow-ellipsis">
                  {Plans.getAvailableTeamPlans().filter((p) => p.chargebeeId === pendingPlanPurchase.planId)[0]?.name}
                </span>
            ...
            >
              ...
              <div className="p-0 my-auto flex flex-col w-2/12">
                <span className="my-auto truncate text-gray-500 overflow-ellipsis">
                  {slots.filter((s) => s.state !== 'cancelled' && s.teamSubscription.id === sub.id).length || '–'}
                </span>
    ...
    <Modal visible={true} onClose={props.onClose}>
      ...
      <div className="border-t border-b border-gray-200 dark:border-gray-800 mt-2 -mx-6 px-6 py-4 space-y-2">
        ...
        <div className="flex flex-col space-y-2">
          ...
          <select name="type" value={type} className="rounded-md w-full" onChange={(e) => setType(e.target.value)}>
    ...
    <div key={key} className="flex flex-col space-y-2 pt-2">
      ...
      <div className="flex flex-grow flex-row space-x-2">
        <input
          ...
          readOnly={!editMode}
          placeholder={
            (!editMode && (renderIdentifier(slot.assigneeIdentifier) || 'e.g. github.com/username')) || undefined
          }
