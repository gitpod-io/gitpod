            ...
            {prebuild?.status === 'aborted' || prebuild?.status === 'timeout' || !!prebuild?.error ? (
              ...
              <button
                ...
                disabled={
                  ...
                  (prebuildInstance?.status.phase !== 'initializing' && prebuildInstance?.status.phase !== 'running')
                }
              ...
              <a className="my-auto" href={gitpodHostUrl.withContext(`${prebuild?.info.changeUrl}`).toString()}>
