                ...
                <ItemField className="flex items-center my-auto">
                  <div className="truncate">
                    ...
                    <p>
                      ...
                      Authored {formatDate(p.info.changeDate)} · {p.info.changeHash?.substring(0, 8)}
                    </p>
                  </div>
                </ItemField>
                <ItemField className="flex">
                  <div className="flex space-x-2 truncate">
                    <span className="font-medium text-gray-500 dark:text-gray-50 truncate" title={p.info.branch}>
                      {p.info.branch}
                    </span>
                  </div>
