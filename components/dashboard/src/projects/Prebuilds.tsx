...
export default function () {
    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            if (project) {
                setProject(project);
                setPrebuilds(await getGitpodService().server.findPrebuilds({
    ...
    const triggerPrebuild = (p: PrebuildInfo) => {
        if (project) {
            getGitpodService().server.triggerPrebuild(project.id, p.branch);
        }
    }
