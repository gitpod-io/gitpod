...
type SetupDebugPairVethsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SetupDebugPairVethsRequest) Reset() {
	*x = SetupDebugPairVethsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *SetupDebugPairVethsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetupDebugPairVethsRequest) ProtoMessage() {}

func (x *SetupDebugPairVethsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_workspace_daemon_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetupDebugPairVethsRequest.ProtoReflect.Descriptor instead.
func (*SetupDebugPairVethsRequest) Descriptor() ([]byte, []int) {
	return file_workspace_daemon_proto_rawDescGZIP(), []int{14}
}

func (x *SetupDebugPairVethsRequest) GetPid() int64 {
	if x != nil {
		return x.Pid
	}
	return 0
...
type SetupDebugPairVethsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *SetupDebugPairVethsResponse) Reset() {
	*x = SetupDebugPairVethsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SetupDebugPairVethsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetupDebugPairVethsResponse) ProtoMessage() {}

func (x *SetupDebugPairVethsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_workspace_daemon_proto_msgTypes[15]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetupDebugPairVethsResponse.ProtoReflect.Descriptor instead.
func (*SetupDebugPairVethsResponse) Descriptor() ([]byte, []int) {
...
type StartInnerLoopRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *StartInnerLoopRequest) Reset() {
	*x = StartInnerLoopRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *StartInnerLoopRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StartInnerLoopRequest) ProtoMessage() {}

func (x *StartInnerLoopRequest) ProtoReflect() protoreflect.Message {
	mi := &file_workspace_daemon_proto_msgTypes[21]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StartInnerLoopRequest.ProtoReflect.Descriptor instead.
func (*StartInnerLoopRequest) Descriptor() ([]byte, []int) {
	return file_workspace_daemon_proto_rawDescGZIP(), []int{21}
}

type StartInnerLoopResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	//
	//	*StartInnerLoopResponse_Data
	//	*StartInnerLoopResponse_ExitCode
	Output isStartInnerLoopResponse_Output `protobuf_oneof:"output"`
}

func (x *StartInnerLoopResponse) Reset() {
	*x = StartInnerLoopResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *StartInnerLoopResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StartInnerLoopResponse) ProtoMessage() {}

func (x *StartInnerLoopResponse) ProtoReflect() protoreflect.Message {
	mi := &file_workspace_daemon_proto_msgTypes[22]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StartInnerLoopResponse.ProtoReflect.Descriptor instead.
func (*StartInnerLoopResponse) Descriptor() ([]byte, []int) {
	return file_workspace_daemon_proto_rawDescGZIP(), []int{22}
}

func (m *StartInnerLoopResponse) GetOutput() isStartInnerLoopResponse_Output {
	if m != nil {
		return m.Output
	}
	return nil
...
func (x *StartInnerLoopResponse) GetData() []byte {
	if x, ok := x.GetOutput().(*StartInnerLoopResponse_Data); ok {
		return x.Data
	}
	return nil
}

func (x *StartInnerLoopResponse) GetExitCode() int32 {
	if x, ok := x.GetOutput().(*StartInnerLoopResponse_ExitCode); ok {
		return x.ExitCode
	}
	return 0
}

type isStartInnerLoopResponse_Output interface {
	isStartInnerLoopResponse_Output()
}

type StartInnerLoopResponse_Data struct {
	Data []byte `protobuf:"bytes,1,opt,name=data,proto3,oneof"`
}

type StartInnerLoopResponse_ExitCode struct {
	ExitCode int32 `protobuf:"varint,2,opt,name=exit_code,json=exitCode,proto3,oneof"`
}

func (*StartInnerLoopResponse_Data) isStartInnerLoopResponse_Output() {}

func (*StartInnerLoopResponse_ExitCode) isStartInnerLoopResponse_Output() {}
...
var file_workspace_daemon_proto_rawDesc = []byte{
	...
	0x53, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xb5, 0x01, 0x0a, 0x18, 0x50, 0x72, 0x65,
	...
	,
	...
	0x6f, 0x64, 0x65, 0x22, 0xd4, 0x01, 0x0a, 0x15, 0x57, 0x72, 0x69, 0x74, 0x65, 0x49, 0x44, 0x4d,
	...
	0x10, 0x0a, 0x03, 0x67, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x03, 0x67, 0x69,
	0x64, 0x12, 0x3c, 0x0a, 0x07, 0x6d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x18, 0x03, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x22, 0x2e, 0x69, 0x77, 0x73, 0x2e, 0x57, 0x72, 0x69, 0x74, 0x65, 0x49, 0x44,
	0x4d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x4d,
	0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x52, 0x07, 0x6d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x1a,
	0x59, 0x0a, 0x07, 0x4d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x12, 0x21, 0x0a, 0x0c, 0x63, 0x6f,
	...
	0x07, 0x68, 0x6f, 0x73, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06,
	0x68, 0x6f, 0x73, 0x74, 0x49, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x22, 0x17, 0x0a, 0x15, 0x45, 0x76,
	0x61, 0x63, 0x75, 0x61, 0x74, 0x65, 0x43, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x22, 0x18, 0x0a, 0x16, 0x45, 0x76, 0x61, 0x63, 0x75, 0x61, 0x74, 0x65, 0x43,
	0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x3c, 0x0a,
	...
	0x22, 0x3d, 0x0a, 0x11, 0x55, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x50, 0x72, 0x6f, 0x63, 0x52, 0x65,
	...
	0x14, 0x0a, 0x12, 0x55, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x50, 0x72, 0x6f, 0x63, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x11, 0x0a, 0x0f, 0x54, 0x65, 0x61, 0x72, 0x64, 0x6f, 0x77,
	0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x2c, 0x0a, 0x10, 0x54, 0x65, 0x61, 0x72,
	...
	,
	...
	,
	...
	,
	...
	0x73, 0x2d, 0x64, 0x61, 0x65, 0x6d, 0x6f, 0x6e, 0x2f, 0x61, 0x70, 0x69, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_workspace_daemon_proto_goTypes = []interface{}{
	...
	(*SetupDebugPairVethsRequest)(nil),    // 15: iws.SetupDebugPairVethsRequest
	(*SetupDebugPairVethsResponse)(nil),   // 16: iws.SetupDebugPairVethsResponse
	(*WorkspaceInfoRequest)(nil),          // 17: iws.WorkspaceInfoRequest
	(*WorkspaceInfoResponse)(nil),         // 18: iws.WorkspaceInfoResponse
	(*Resources)(nil),                     // 19: iws.Resources
	(*Cpu)(nil),                           // 20: iws.Cpu
	(*Memory)(nil),                        // 21: iws.Memory
	(*StartInnerLoopRequest)(nil),         // 22: iws.StartInnerLoopRequest
	(*StartInnerLoopResponse)(nil),        // 23: iws.StartInnerLoopResponse
...
var file_workspace_daemon_proto_depIdxs = []int32{
	...
	19, // 2: iws.WorkspaceInfoResponse.resources:type_name -> iws.Resources
	20, // 3: iws.Resources.cpu:type_name -> iws.Cpu
	21, // 4: iws.Resources.memory:type_name -> iws.Memory
	...
	17, // 14: iws.InWorkspaceService.WorkspaceInfo:input_type -> iws.WorkspaceInfoRequest
	15, // 15: iws.InWorkspaceService.SetupDebugPairVeths:input_type -> iws.SetupDebugPairVethsRequest
	17, // 16: iws.WorkspaceInfoService.WorkspaceInfo:input_type -> iws.WorkspaceInfoRequest
	22, // 17: iws.WorkspaceInnerLoop.StartInnerLoop:input_type -> iws.StartInnerLoopRequest
	...
	12, // 25: iws.InWorkspaceService.Teardown:output_type -> iws.TeardownResponse
	14, // 26: iws.InWorkspaceService.SetupPairVeths:output_type -> iws.SetupPairVethsResponse
	18, // 27: iws.InWorkspaceService.WorkspaceInfo:output_type -> iws.WorkspaceInfoResponse
	16, // 28: iws.InWorkspaceService.SetupDebugPairVeths:output_type -> iws.SetupDebugPairVethsResponse
	18, // 29: iws.WorkspaceInfoService.WorkspaceInfo:output_type -> iws.WorkspaceInfoResponse
	23, // 30: iws.WorkspaceInnerLoop.StartInnerLoop:output_type -> iws.StartInnerLoopResponse
...
func file_workspace_daemon_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_workspace_daemon_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SetupDebugPairVethsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_workspace_daemon_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SetupDebugPairVethsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_workspace_daemon_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StartInnerLoopRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_workspace_daemon_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StartInnerLoopResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_workspace_daemon_proto_msgTypes[22].OneofWrappers = []interface{}{
		(*StartInnerLoopResponse_Data)(nil),
		(*StartInnerLoopResponse_ExitCode)(nil),
	}
	type x struct{}
