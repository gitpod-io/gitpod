...
interface IWorkspaceContentServiceService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
    ...
    restartRing1: IWorkspaceContentServiceService_IRestartRing1;
}
...
interface IWorkspaceContentServiceService_IRestartRing1 extends grpc.MethodDefinition<daemon_pb.RestartRing1Request, daemon_pb.RestartRing1Response> {
    path: "/wsdaemon.WorkspaceContentService/RestartRing1";
    requestStream: false;
    responseStream: false;
    requestSerialize: grpc.serialize<daemon_pb.RestartRing1Request>;
    requestDeserialize: grpc.deserialize<daemon_pb.RestartRing1Request>;
    responseSerialize: grpc.serialize<daemon_pb.RestartRing1Response>;
    responseDeserialize: grpc.deserialize<daemon_pb.RestartRing1Response>;
}
...
export interface IWorkspaceContentServiceServer extends grpc.UntypedServiceImplementation {
    ...
    restartRing1: grpc.handleUnaryCall<daemon_pb.RestartRing1Request, daemon_pb.RestartRing1Response>;
}
...
export interface IWorkspaceContentServiceClient {
    ...
    restartRing1(request: daemon_pb.RestartRing1Request, callback: (error: grpc.ServiceError | null, response: daemon_pb.RestartRing1Response) => void): grpc.ClientUnaryCall;
    restartRing1(request: daemon_pb.RestartRing1Request, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: daemon_pb.RestartRing1Response) => void): grpc.ClientUnaryCall;
    restartRing1(request: daemon_pb.RestartRing1Request, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: daemon_pb.RestartRing1Response) => void): grpc.ClientUnaryCall;
}
...
export class WorkspaceContentServiceClient extends grpc.Client implements IWorkspaceContentServiceClient {
    ...
    public restartRing1(request: daemon_pb.RestartRing1Request, callback: (error: grpc.ServiceError | null, response: daemon_pb.RestartRing1Response) => void): grpc.ClientUnaryCall;
    public restartRing1(request: daemon_pb.RestartRing1Request, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: daemon_pb.RestartRing1Response) => void): grpc.ClientUnaryCall;
    public restartRing1(request: daemon_pb.RestartRing1Request, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: daemon_pb.RestartRing1Response) => void): grpc.ClientUnaryCall;
}
