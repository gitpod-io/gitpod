...
interface IWorkspaceContentServiceService_IInitWorkspace
    extends grpc.MethodDefinition<daemon_pb.InitWorkspaceRequest, daemon_pb.InitWorkspaceResponse> {
...
interface IWorkspaceContentServiceService_IWaitForInit
    extends grpc.MethodDefinition<daemon_pb.WaitForInitRequest, daemon_pb.WaitForInitResponse> {
...
interface IWorkspaceContentServiceService_IIsWorkspaceExists
    extends grpc.MethodDefinition<daemon_pb.IsWorkspaceExistsRequest, daemon_pb.IsWorkspaceExistsResponse> {
...
interface IWorkspaceContentServiceService_ITakeSnapshot
    extends grpc.MethodDefinition<daemon_pb.TakeSnapshotRequest, daemon_pb.TakeSnapshotResponse> {
...
interface IWorkspaceContentServiceService_IDisposeWorkspace
    extends grpc.MethodDefinition<daemon_pb.DisposeWorkspaceRequest, daemon_pb.DisposeWorkspaceResponse> {
...
interface IWorkspaceContentServiceService_IBackupWorkspace
    extends grpc.MethodDefinition<daemon_pb.BackupWorkspaceRequest, daemon_pb.BackupWorkspaceResponse> {
...
export interface IWorkspaceContentServiceClient {
    initWorkspace(
        request: daemon_pb.InitWorkspaceRequest,
        callback: (error: grpc.ServiceError | null, response: daemon_pb.InitWorkspaceResponse) => void,
    ...
    waitForInit(
        request: daemon_pb.WaitForInitRequest,
        callback: (error: grpc.ServiceError | null, response: daemon_pb.WaitForInitResponse) => void,
    ): grpc.ClientUnaryCall;
    waitForInit(
        request: daemon_pb.WaitForInitRequest,
        metadata: grpc.Metadata,
    ...
    isWorkspaceExists(
        request: daemon_pb.IsWorkspaceExistsRequest,
        callback: (error: grpc.ServiceError | null, response: daemon_pb.IsWorkspaceExistsResponse) => void,
    ): grpc.ClientUnaryCall;
    isWorkspaceExists(
        request: daemon_pb.IsWorkspaceExistsRequest,
        metadata: grpc.Metadata,
    ...
    takeSnapshot(
        request: daemon_pb.TakeSnapshotRequest,
        callback: (error: grpc.ServiceError | null, response: daemon_pb.TakeSnapshotResponse) => void,
    ): grpc.ClientUnaryCall;
    takeSnapshot(
        request: daemon_pb.TakeSnapshotRequest,
        metadata: grpc.Metadata,
    ...
    disposeWorkspace(
        request: daemon_pb.DisposeWorkspaceRequest,
        callback: (error: grpc.ServiceError | null, response: daemon_pb.DisposeWorkspaceResponse) => void,
    ): grpc.ClientUnaryCall;
    disposeWorkspace(
        request: daemon_pb.DisposeWorkspaceRequest,
        metadata: grpc.Metadata,
    ...
    backupWorkspace(
        request: daemon_pb.BackupWorkspaceRequest,
        callback: (error: grpc.ServiceError | null, response: daemon_pb.BackupWorkspaceResponse) => void,
    ): grpc.ClientUnaryCall;
    backupWorkspace(
        request: daemon_pb.BackupWorkspaceRequest,
        metadata: grpc.Metadata,
