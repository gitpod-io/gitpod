...
function serialize_wsdaemon_RestartRing1Request(arg) {
  if (!(arg instanceof daemon_pb.RestartRing1Request)) {
    throw new Error('Expected argument of type wsdaemon.RestartRing1Request');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_wsdaemon_RestartRing1Request(buffer_arg) {
  return daemon_pb.RestartRing1Request.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_wsdaemon_RestartRing1Response(arg) {
  if (!(arg instanceof daemon_pb.RestartRing1Response)) {
    throw new Error('Expected argument of type wsdaemon.RestartRing1Response');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_wsdaemon_RestartRing1Response(buffer_arg) {
  return daemon_pb.RestartRing1Response.deserializeBinary(new Uint8Array(buffer_arg));
}
...
restartRing1: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: daemon_pb.RestartRing1Request,
    responseType: daemon_pb.RestartRing1Response,
    requestSerialize: serialize_wsdaemon_RestartRing1Request,
    requestDeserialize: deserialize_wsdaemon_RestartRing1Request,
    responseSerialize: serialize_wsdaemon_RestartRing1Response,
    responseDeserialize: deserialize_wsdaemon_RestartRing1Response,
  },
};
