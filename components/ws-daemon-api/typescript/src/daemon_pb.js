...
goog.exportSymbol('proto.wsdaemon.RestartRing1Request', null, global);
goog.exportSymbol('proto.wsdaemon.RestartRing1Request.Type', null, global);
goog.exportSymbol('proto.wsdaemon.RestartRing1Response', null, global);
 ...
 * @constructor
 */
proto.wsdaemon.RestartRing1Request = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.wsdaemon.RestartRing1Request, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.wsdaemon.RestartRing1Request.displayName = 'proto.wsdaemon.RestartRing1Request';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.wsdaemon.RestartRing1Response = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.wsdaemon.RestartRing1Response, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.wsdaemon.RestartRing1Response.displayName = 'proto.wsdaemon.RestartRing1Response';
}
 ...
 * @return {!Object}
 */
proto.wsdaemon.RestartRing1Request.prototype.toObject = function(opt_includeInstance) {
  return proto.wsdaemon.RestartRing1Request.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.wsdaemon.RestartRing1Request} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.wsdaemon.RestartRing1Request.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.wsdaemon.RestartRing1Request}
 */
proto.wsdaemon.RestartRing1Request.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.wsdaemon.RestartRing1Request;
  return proto.wsdaemon.RestartRing1Request.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.wsdaemon.RestartRing1Request} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.wsdaemon.RestartRing1Request}
 */
proto.wsdaemon.RestartRing1Request.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      ...
      break;
    case 2:
      var value = /** @type {!proto.wsdaemon.RestartRing1Request.Type} */ (reader.readEnum());
      msg.setType(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.wsdaemon.RestartRing1Request.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.wsdaemon.RestartRing1Request.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.wsdaemon.RestartRing1Request} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.wsdaemon.RestartRing1Request.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @enum {number}
 */
proto.wsdaemon.RestartRing1Request.Type = {
  NORMAL: 0,
  INNER_LOOP: 1
};
 ...
 * @return {string}
 */
proto.wsdaemon.RestartRing1Request.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.wsdaemon.RestartRing1Request} returns this
 */
proto.wsdaemon.RestartRing1Request.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!proto.wsdaemon.RestartRing1Request.Type}
 */
proto.wsdaemon.RestartRing1Request.prototype.getType = function() {
  return /** @type {!proto.wsdaemon.RestartRing1Request.Type} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/**
 * @param {!proto.wsdaemon.RestartRing1Request.Type} value
 * @return {!proto.wsdaemon.RestartRing1Request} returns this
 */
proto.wsdaemon.RestartRing1Request.prototype.setType = function(value) {
 ...
 * @return {!Object}
 */
proto.wsdaemon.RestartRing1Response.prototype.toObject = function(opt_includeInstance) {
  return proto.wsdaemon.RestartRing1Response.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.wsdaemon.RestartRing1Response} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.wsdaemon.RestartRing1Response.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.wsdaemon.RestartRing1Response}
 */
proto.wsdaemon.RestartRing1Response.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.wsdaemon.RestartRing1Response;
  return proto.wsdaemon.RestartRing1Response.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.wsdaemon.RestartRing1Response} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.wsdaemon.RestartRing1Response}
 */
proto.wsdaemon.RestartRing1Response.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.wsdaemon.RestartRing1Response.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.wsdaemon.RestartRing1Response.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.wsdaemon.RestartRing1Response} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.wsdaemon.RestartRing1Response.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
