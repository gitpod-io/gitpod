...
goog.exportSymbol('proto.workspacemanagerbridge.AdmissionPreference.Region', null, global);
 ...
 * @constructor
 */
proto.workspacemanagerbridge.AdmissionPreference.Region = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.workspacemanagerbridge.AdmissionPreference.Region, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.workspacemanagerbridge.AdmissionPreference.Region.displayName = 'proto.workspacemanagerbridge.AdmissionPreference.Region';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.workspacemanagerbridge.AdmissionPreference.oneofGroups_ = [[1,2]];
...
proto.workspacemanagerbridge.AdmissionPreference.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    region: (f = msg.getRegion()) && proto.workspacemanagerbridge.AdmissionPreference.Region.toObject(includeInstance, f)
  };
...
proto.workspacemanagerbridge.AdmissionPreference.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.workspacemanagerbridge.AdmissionPreference.Region;
      reader.readMessage(value,proto.workspacemanagerbridge.AdmissionPreference.Region.deserializeBinaryFromReader);
      msg.setRegion(value);
      break;
    default:
      reader.skipField();
...
proto.workspacemanagerbridge.AdmissionPreference.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.workspacemanagerbridge.AdmissionPreference.Region.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Object}
 */
proto.workspacemanagerbridge.AdmissionPreference.Region.prototype.toObject = function(opt_includeInstance) {
  return proto.workspacemanagerbridge.AdmissionPreference.Region.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.workspacemanagerbridge.AdmissionPreference.Region} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.workspacemanagerbridge.AdmissionPreference.Region.toObject = function(includeInstance, msg) {
  var f, obj = {
    name: jspb.Message.getFieldWithDefault(msg, 1, ""),
    rttEndpoint: jspb.Message.getFieldWithDefault(msg, 2, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.workspacemanagerbridge.AdmissionPreference.Region}
 */
proto.workspacemanagerbridge.AdmissionPreference.Region.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.workspacemanagerbridge.AdmissionPreference.Region;
  return proto.workspacemanagerbridge.AdmissionPreference.Region.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.workspacemanagerbridge.AdmissionPreference.Region} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.workspacemanagerbridge.AdmissionPreference.Region}
 */
proto.workspacemanagerbridge.AdmissionPreference.Region.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.workspacemanagerbridge.AdmissionPreference.Region.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.workspacemanagerbridge.AdmissionPreference.Region.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.workspacemanagerbridge.AdmissionPreference.Region} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.workspacemanagerbridge.AdmissionPreference.Region.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.workspacemanagerbridge.AdmissionPreference.Region.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.workspacemanagerbridge.AdmissionPreference.Region} returns this
 */
proto.workspacemanagerbridge.AdmissionPreference.Region.prototype.setName = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional string rtt_endpoint = 2;
 * @return {string}
 */
proto.workspacemanagerbridge.AdmissionPreference.Region.prototype.getRttEndpoint = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.workspacemanagerbridge.AdmissionPreference.Region} returns this
 */
proto.workspacemanagerbridge.AdmissionPreference.Region.prototype.setRttEndpoint = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {?proto.workspacemanagerbridge.AdmissionPreference.Region}
 */
proto.workspacemanagerbridge.AdmissionPreference.prototype.getRegion = function() {
  return /** @type{?proto.workspacemanagerbridge.AdmissionPreference.Region} */ (
    jspb.Message.getWrapperField(this, proto.workspacemanagerbridge.AdmissionPreference.Region, 2));
};


/**
 * @param {?proto.workspacemanagerbridge.AdmissionPreference.Region|undefined} value
 * @return {!proto.workspacemanagerbridge.AdmissionPreference} returns this
*/
proto.workspacemanagerbridge.AdmissionPreference.prototype.setRegion = function(value) {
  return jspb.Message.setOneofWrapperField(this, 2, proto.workspacemanagerbridge.AdmissionPreference.oneofGroups_[0], value);
};
 ...
 * @return {!proto.workspacemanagerbridge.AdmissionPreference} returns this
 */
proto.workspacemanagerbridge.AdmissionPreference.prototype.clearRegion = function() {
 ...
 * @return {boolean}
 */
proto.workspacemanagerbridge.AdmissionPreference.prototype.hasRegion = function() {
  return jspb.Message.getField(this, 2) != null;
};
