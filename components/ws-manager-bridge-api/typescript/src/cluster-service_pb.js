    ...
    proto.workspacemanagerbridge.RegisterRequest.toObject = function (includeInstance, msg) {
        var f,
            obj = {
                ...
                hints:
                    (f = msg.getHints()) && proto.workspacemanagerbridge.RegistrationHints.toObject(includeInstance, f),
...
if (jspb.Message.GENERATE_TO_OBJECT) {
     ...
     * @return {!Object}
     */
    proto.workspacemanagerbridge.AdmissionConstraint.FeaturePreview.prototype.toObject = function (
        opt_includeInstance,
    ) {
    ...
    while (reader.nextField()) {
        ...
        switch (field) {
            ...
            case 5:
                ...
                reader.readMessage(
                    value,
                    proto.workspacemanagerbridge.ModifyAdmissionConstraint.deserializeBinaryFromReader,
                );
...
proto.workspacemanagerbridge.UpdateRequest.prototype.setAdmissionConstraint = function (value) {
    return jspb.Message.setOneofWrapperField(
        this,
        5,
        proto.workspacemanagerbridge.UpdateRequest.oneofGroups_[0],
        value,
    );
};
    ...
    proto.workspacemanagerbridge.ModifyAdmissionConstraint.toObject = function (includeInstance, msg) {
        var f,
            obj = {
                ...
                constraint:
                    (f = msg.getConstraint()) &&
                    proto.workspacemanagerbridge.AdmissionConstraint.toObject(includeInstance, f),
            };
