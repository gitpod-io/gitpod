...
export class AdmissionConstraint extends jspb.Message {
    ...
    hasMaturityLevel(): boolean;
    clearMaturityLevel(): void;
    getMaturityLevel(): AdmissionConstraint.MaturityLevel;
    setMaturityLevel(value: AdmissionConstraint.MaturityLevel): AdmissionConstraint;
...
export namespace AdmissionConstraint {
    export type AsObject = {
        ...
        maturityLevel: AdmissionConstraint.MaturityLevel,
    }
