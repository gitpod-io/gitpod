...
// @generated from file gitpod/stable/v1/prebuilds.proto (package gitpod.stable.v1, syntax proto3)
/* eslint-disable */
/* @ts-nocheck */
...
/**
 * @generated from message gitpod.stable.v1.GetPrebuildRequest
 */
export class GetPrebuildRequest extends Message<GetPrebuildRequest> {
  ...
  static readonly typeName = "gitpod.stable.v1.GetPrebuildRequest";
...
/**
 * @generated from message gitpod.stable.v1.GetPrebuildResponse
 */
export class GetPrebuildResponse extends Message<GetPrebuildResponse> {
  /**
   * @generated from field: gitpod.stable.v1.Prebuild prebuild = 1;
   */
  prebuild?: Prebuild;
  ...
  static readonly runtime = proto3;
  static readonly typeName = "gitpod.stable.v1.GetPrebuildResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message gitpod.stable.v1.GetRunningPrebuildRequest
 */
export class GetRunningPrebuildRequest extends Message<GetRunningPrebuildRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "gitpod.stable.v1.GetRunningPrebuildRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message gitpod.stable.v1.GetRunningPrebuildResponse
 */
export class GetRunningPrebuildResponse extends Message<GetRunningPrebuildResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "gitpod.stable.v1.GetRunningPrebuildResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "prebuild", kind: "message", T: Prebuild },
  ]);
...
/**
 * @generated from message gitpod.stable.v1.ListenToPrebuildStatusRequest
 */
export class ListenToPrebuildStatusRequest extends Message<ListenToPrebuildStatusRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "gitpod.stable.v1.ListenToPrebuildStatusRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "prebuild_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message gitpod.stable.v1.ListenToPrebuildStatusResponse
 */
export class ListenToPrebuildStatusResponse extends Message<ListenToPrebuildStatusResponse> {
  /**
   * @generated from field: gitpod.stable.v1.PrebuildStatus status = 1;
   */
  ...
  static readonly runtime = proto3;
  static readonly typeName = "gitpod.stable.v1.ListenToPrebuildStatusResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message gitpod.stable.v1.ListenToPrebuildLogsRequest
 */
export class ListenToPrebuildLogsRequest extends Message<ListenToPrebuildLogsRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "gitpod.stable.v1.ListenToPrebuildLogsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "prebuild_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message gitpod.stable.v1.ListenToPrebuildLogsResponse
 */
export class ListenToPrebuildLogsResponse extends Message<ListenToPrebuildLogsResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "gitpod.stable.v1.ListenToPrebuildLogsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message gitpod.stable.v1.Prebuild
 */
export class Prebuild extends Message<Prebuild> {
  ...
  /**
   * @generated from field: gitpod.stable.v1.PrebuildSpec spec = 2;
   */
  spec?: PrebuildSpec;

  /**
   * @generated from field: gitpod.stable.v1.PrebuildStatus status = 3;
   */
  status?: PrebuildStatus;
  ...
  static readonly runtime = proto3;
  static readonly typeName = "gitpod.stable.v1.Prebuild";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "prebuild_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message gitpod.stable.v1.PrebuildSpec
 */
export class PrebuildSpec extends Message<PrebuildSpec> {
  /**
   * @generated from field: gitpod.stable.v1.WorkspaceContext context = 1;
   */
  ...
  static readonly runtime = proto3;
  static readonly typeName = "gitpod.stable.v1.PrebuildSpec";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message gitpod.stable.v1.PrebuildStatus
 */
export class PrebuildStatus extends Message<PrebuildStatus> {
  /**
   * Phase is the prebuild phase we're in
   *
   * @generated from field: gitpod.stable.v1.PrebuildStatus.Phase phase = 1;
   */
   ...
   *
   * @generated from field: gitpod.stable.v1.PrebuildStatus.Result result = 2;
   */
  ...
  static readonly runtime = proto3;
  static readonly typeName = "gitpod.stable.v1.PrebuildStatus";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from enum gitpod.stable.v1.PrebuildStatus.Phase
 */
...
proto3.util.setEnumType(PrebuildStatus_Phase, "gitpod.stable.v1.PrebuildStatus.Phase", [
...
/**
 * @generated from enum gitpod.stable.v1.PrebuildStatus.Result
 */
...
proto3.util.setEnumType(PrebuildStatus_Result, "gitpod.stable.v1.PrebuildStatus.Result", [
