...
/**
 * @generated from service gitpod.stable.v1.PrebuildsService
 */
export const PrebuildsService = {
  typeName: "gitpod.stable.v1.PrebuildsService",
  methods: {
    /**
     ...
     *
     * @generated from rpc gitpod.stable.v1.PrebuildsService.GetPrebuild
     */
    getPrebuild: {
      name: "GetPrebuild",
     ...
     *
     * @generated from rpc gitpod.stable.v1.PrebuildsService.GetRunningPrebuild
     */
    getRunningPrebuild: {
     ...
     *
     * @generated from rpc gitpod.stable.v1.PrebuildsService.ListenToPrebuildStatus
     */
     ...
     *
     * @generated from rpc gitpod.stable.v1.PrebuildsService.ListenToPrebuildLogs
     */
