...
// @generated from file gitpod/stable/v1/pagination.proto (package gitpod.stable.v1, syntax proto3)
/* eslint-disable */
/* @ts-nocheck */
...
/**
 * @generated from message gitpod.stable.v1.Pagination
 */
export class Pagination extends Message<Pagination> {
  ...
  static readonly typeName = "gitpod.stable.v1.Pagination";
