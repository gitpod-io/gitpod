...
// @generated from file gitpod/stable/pagination.proto (package gitpod.stable, syntax proto3)
/* eslint-disable */
/* @ts-nocheck */
...
/**
 * @generated from message gitpod.stable.Pagination
 */
export class Pagination extends Message<Pagination> {
  ...
  static readonly typeName = "gitpod.stable.Pagination";
