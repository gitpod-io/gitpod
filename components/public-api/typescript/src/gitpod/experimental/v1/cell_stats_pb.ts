...
export class GetUserStatsRequest extends Message<GetUserStatsRequest> {
  /**
   * The date for which the stats are requested, optional.
   *
...
export class GetUserStatsResponse extends Message<GetUserStatsResponse> {
  /**
   * The count of unique concurrent users.
   *
   * @generated from field: uint64 unique_concurrent_users = 1;
   */
  uniqueConcurrentUsers = protoInt64.zero;

  /**
   * The count of all time users.
   *
   * @generated from field: uint64 all_time_users = 2;
   */
  allTimeUsers = protoInt64.zero;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "unique_concurrent_users", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 2, name: "all_time_users", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
  ]);
