...
/**
 * @generated from message gitpod.experimental.v1.SendCloseSignalRequest
 */
export class SendCloseSignalRequest extends Message<SendCloseSignalRequest> {
  /**
   * @generated from field: string workspace_id = 1;
   */
  workspaceId = "";

  constructor(data?: PartialMessage<SendCloseSignalRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime = proto3;
  static readonly typeName = "gitpod.experimental.v1.SendCloseSignalRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "workspace_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SendCloseSignalRequest {
    return new SendCloseSignalRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SendCloseSignalRequest {
    return new SendCloseSignalRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SendCloseSignalRequest {
    return new SendCloseSignalRequest().fromJsonString(jsonString, options);
  }

  static equals(a: SendCloseSignalRequest | PlainMessage<SendCloseSignalRequest> | undefined, b: SendCloseSignalRequest | PlainMessage<SendCloseSignalRequest> | undefined): boolean {
    return proto3.util.equals(SendCloseSignalRequest, a, b);
  }
}

/**
 * @generated from message gitpod.experimental.v1.SendCloseSignalResponse
 */
export class SendCloseSignalResponse extends Message<SendCloseSignalResponse> {
  constructor(data?: PartialMessage<SendCloseSignalResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime = proto3;
  static readonly typeName = "gitpod.experimental.v1.SendCloseSignalResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SendCloseSignalResponse {
    return new SendCloseSignalResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SendCloseSignalResponse {
    return new SendCloseSignalResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SendCloseSignalResponse {
    return new SendCloseSignalResponse().fromJsonString(jsonString, options);
  }

  static equals(a: SendCloseSignalResponse | PlainMessage<SendCloseSignalResponse> | undefined, b: SendCloseSignalResponse | PlainMessage<SendCloseSignalResponse> | undefined): boolean {
    return proto3.util.equals(SendCloseSignalResponse, a, b);
  }
}
