...
goog.exportSymbol('proto.gitpod.v1.WorkspaceMetadata', null, global);
/**
 ...
 * @constructor
 */
proto.gitpod.v1.WorkspaceMetadata = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.gitpod.v1.WorkspaceMetadata, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.gitpod.v1.WorkspaceMetadata.displayName = 'proto.gitpod.v1.WorkspaceMetadata';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.gitpod.v1.ListWorkspacesResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.gitpod.v1.Workspace.toObject, includeInstance)
  };
 ...
 * @return {!Array<!proto.gitpod.v1.Workspace>}
 */
proto.gitpod.v1.ListWorkspacesResponse.prototype.getResultList = function() {
  return /** @type{!Array<!proto.gitpod.v1.Workspace>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.gitpod.v1.Workspace, 3));
};


/**
 * @param {!Array<!proto.gitpod.v1.Workspace>} value
 * @return {!proto.gitpod.v1.ListWorkspacesResponse} returns this
*/
...
/**
 * @param {!proto.gitpod.v1.Workspace=} opt_value
...
proto.gitpod.v1.ListWorkspacesResponse.prototype.addResult = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 3, opt_value, proto.gitpod.v1.Workspace, opt_index);
};
...
proto.gitpod.v1.Workspace.toObject = function(includeInstance, msg) {
  var f, obj = {
    metadata: (f = msg.getMetadata()) && proto.gitpod.v1.WorkspaceMetadata.toObject(includeInstance, f)
  };
...
proto.gitpod.v1.Workspace.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.gitpod.v1.WorkspaceMetadata;
      reader.readMessage(value,proto.gitpod.v1.WorkspaceMetadata.deserializeBinaryFromReader);
...
proto.gitpod.v1.Workspace.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.gitpod.v1.WorkspaceMetadata.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional WorkspaceMetadata metadata = 1;
 * @return {?proto.gitpod.v1.WorkspaceMetadata}
 */
proto.gitpod.v1.Workspace.prototype.getMetadata = function() {
  return /** @type{?proto.gitpod.v1.WorkspaceMetadata} */ (
    jspb.Message.getWrapperField(this, proto.gitpod.v1.WorkspaceMetadata, 1));
};


/**
 * @param {?proto.gitpod.v1.WorkspaceMetadata|undefined} value
 * @return {!proto.gitpod.v1.Workspace} returns this
*/
proto.gitpod.v1.Workspace.prototype.setMetadata = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.gitpod.v1.Workspace} returns this
 */
proto.gitpod.v1.Workspace.prototype.clearMetadata = function() {
 ...
 * @return {boolean}
 */
proto.gitpod.v1.Workspace.prototype.hasMetadata = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {!Object}
 */
proto.gitpod.v1.WorkspaceMetadata.prototype.toObject = function(opt_includeInstance) {
  return proto.gitpod.v1.WorkspaceMetadata.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.gitpod.v1.WorkspaceMetadata} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gitpod.v1.WorkspaceMetadata.toObject = function(includeInstance, msg) {
  var f, obj = {
    workspaceId: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * @return {!proto.gitpod.v1.WorkspaceMetadata}
 */
proto.gitpod.v1.WorkspaceMetadata.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gitpod.v1.WorkspaceMetadata;
  return proto.gitpod.v1.WorkspaceMetadata.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gitpod.v1.WorkspaceMetadata} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gitpod.v1.WorkspaceMetadata}
 */
proto.gitpod.v1.WorkspaceMetadata.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.gitpod.v1.WorkspaceMetadata.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.gitpod.v1.WorkspaceMetadata.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gitpod.v1.WorkspaceMetadata} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gitpod.v1.WorkspaceMetadata.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getWorkspaceId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.gitpod.v1.WorkspaceMetadata.prototype.getWorkspaceId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.gitpod.v1.WorkspaceMetadata} returns this
 */
proto.gitpod.v1.WorkspaceMetadata.prototype.setWorkspaceId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.gitpod.v1.WorkspaceMetadata.prototype.getOwnerId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.gitpod.v1.WorkspaceMetadata} returns this
 */
proto.gitpod.v1.WorkspaceMetadata.prototype.setOwnerId = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.gitpod.v1.WorkspaceMetadata.prototype.getProjectId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.gitpod.v1.WorkspaceMetadata} returns this
 */
proto.gitpod.v1.WorkspaceMetadata.prototype.setProjectId = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
