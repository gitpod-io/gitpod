...
export class WatchWorkspaceImageBuildLogsResponse extends Message<WatchWorkspaceImageBuildLogsResponse> {
   ...
   *
   * @generated from field: gitpod.v1.WatchWorkspaceImageBuildLogsResponse.Log logs = 1;
   */
  logs?: WatchWorkspaceImageBuildLogsResponse_Log;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "logs", kind: "message", T: WatchWorkspaceImageBuildLogsResponse_Log },
