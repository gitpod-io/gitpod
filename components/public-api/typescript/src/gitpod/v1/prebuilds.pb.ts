...
export function prebuildStatus_PhaseToJSON(object: PrebuildStatus_Phase): string {
  switch (object) {
...
export function prebuildStatus_ResultToJSON(object: PrebuildStatus_Result): string {
  switch (object) {
...
export const GetPrebuildRequest = {
  ...
  fromJSON(object: any): GetPrebuildRequest {
    return { prebuildId: isSet(object.prebuildId) ? String(object.prebuildId) : "" };
  },

  toJSON(message: GetPrebuildRequest): unknown {
    const obj: any = {};
...
export const GetPrebuildResponse = {
  ...
  fromJSON(object: any): GetPrebuildResponse {
    return { prebuild: isSet(object.prebuild) ? Prebuild.fromJSON(object.prebuild) : undefined };
  },

  toJSON(message: GetPrebuildResponse): unknown {
    const obj: any = {};
    message.prebuild !== undefined && (obj.prebuild = message.prebuild ? Prebuild.toJSON(message.prebuild) : undefined);
    return obj;
  },
...
export const GetRunningPrebuildRequest = {
  ...
  fromJSON(object: any): GetRunningPrebuildRequest {
    return { contextUrl: isSet(object.contextUrl) ? String(object.contextUrl) : "" };
  },

  toJSON(message: GetRunningPrebuildRequest): unknown {
    const obj: any = {};
...
export const GetRunningPrebuildResponse = {
  ...
  fromJSON(object: any): GetRunningPrebuildResponse {
    return { prebuild: isSet(object.prebuild) ? Prebuild.fromJSON(object.prebuild) : undefined };
  },

  toJSON(message: GetRunningPrebuildResponse): unknown {
    const obj: any = {};
    message.prebuild !== undefined && (obj.prebuild = message.prebuild ? Prebuild.toJSON(message.prebuild) : undefined);
    return obj;
  },
...
export const ListenToPrebuildStatusRequest = {
  ...
  fromJSON(object: any): ListenToPrebuildStatusRequest {
    return { prebuildId: isSet(object.prebuildId) ? String(object.prebuildId) : "" };
  },

  toJSON(message: ListenToPrebuildStatusRequest): unknown {
    const obj: any = {};
    message.prebuildId !== undefined && (obj.prebuildId = message.prebuildId);
    return obj;
  },
...
export const ListenToPrebuildStatusResponse = {
  ...
  fromJSON(object: any): ListenToPrebuildStatusResponse {
    return { status: isSet(object.status) ? PrebuildStatus.fromJSON(object.status) : undefined };
  },

  toJSON(message: ListenToPrebuildStatusResponse): unknown {
    const obj: any = {};
    message.status !== undefined && (obj.status = message.status ? PrebuildStatus.toJSON(message.status) : undefined);
    return obj;
  },
...
export const ListenToPrebuildLogsRequest = {
  ...
  fromJSON(object: any): ListenToPrebuildLogsRequest {
    return { prebuildId: isSet(object.prebuildId) ? String(object.prebuildId) : "" };
  },

  toJSON(message: ListenToPrebuildLogsRequest): unknown {
    const obj: any = {};
    message.prebuildId !== undefined && (obj.prebuildId = message.prebuildId);
    return obj;
  },
...
export const ListenToPrebuildLogsResponse = {
  ...
  fromJSON(object: any): ListenToPrebuildLogsResponse {
    return { line: isSet(object.line) ? String(object.line) : "" };
  },

  toJSON(message: ListenToPrebuildLogsResponse): unknown {
    const obj: any = {};
...
export const Prebuild = {
  ...
  fromJSON(object: any): Prebuild {
    return {
      prebuildId: isSet(object.prebuildId) ? String(object.prebuildId) : "",
      spec: isSet(object.spec) ? PrebuildSpec.fromJSON(object.spec) : undefined,
      status: isSet(object.status) ? PrebuildStatus.fromJSON(object.status) : undefined,
    };
  },

  toJSON(message: Prebuild): unknown {
    const obj: any = {};
    message.prebuildId !== undefined && (obj.prebuildId = message.prebuildId);
    message.spec !== undefined && (obj.spec = message.spec ? PrebuildSpec.toJSON(message.spec) : undefined);
    message.status !== undefined && (obj.status = message.status ? PrebuildStatus.toJSON(message.status) : undefined);
    return obj;
  },
...
export const PrebuildSpec = {
  ...
  fromJSON(object: any): PrebuildSpec {
    return {
  ...
  toJSON(message: PrebuildSpec): unknown {
    const obj: any = {};
...
export const PrebuildStatus = {
  ...
  fromJSON(object: any): PrebuildStatus {
    return {
      phase: isSet(object.phase) ? prebuildStatus_PhaseFromJSON(object.phase) : PrebuildStatus_Phase.PHASE_UNSPECIFIED,
      result: isSet(object.result)
        ? prebuildStatus_ResultFromJSON(object.result)
        : PrebuildStatus_Result.RESULT_UNSPECIFIED,
      resultMessage: isSet(object.resultMessage) ? String(object.resultMessage) : "",
    };
  },

  toJSON(message: PrebuildStatus): unknown {
    const obj: any = {};
    message.phase !== undefined && (obj.phase = prebuildStatus_PhaseToJSON(message.phase));
    message.result !== undefined && (obj.result = prebuildStatus_ResultToJSON(message.result));
    message.resultMessage !== undefined && (obj.resultMessage = message.resultMessage);
    return obj;
  },
