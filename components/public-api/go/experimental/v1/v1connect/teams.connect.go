...
type TeamsServiceClient interface {
	...
	// UpdateTeam updates the specified team.
	UpdateTeam(context.Context, *connect_go.Request[v1.UpdateTeamRequest]) (*connect_go.Response[v1.UpdateTeamResponse], error)
...
func NewTeamsServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) TeamsServiceClient {
	...
	return &teamsServiceClient{
		...
		updateTeam: connect_go.NewClient[v1.UpdateTeamRequest, v1.UpdateTeamResponse](
			httpClient,
			baseURL+"/gitpod.experimental.v1.TeamsService/UpdateTeam",
			opts...,
		),
...
type teamsServiceClient struct {
	...
	updateTeam          *connect_go.Client[v1.UpdateTeamRequest, v1.UpdateTeamResponse]
...
// UpdateTeam calls gitpod.experimental.v1.TeamsService.UpdateTeam.
func (c *teamsServiceClient) UpdateTeam(ctx context.Context, req *connect_go.Request[v1.UpdateTeamRequest]) (*connect_go.Response[v1.UpdateTeamResponse], error) {
...
func NewTeamsServiceHandler(svc TeamsServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/gitpod.experimental.v1.TeamsService/UpdateTeam", connect_go.NewUnaryHandler(
		"/gitpod.experimental.v1.TeamsService/UpdateTeam",
		svc.UpdateTeam,
		opts...,
	))
...
func (UnimplementedTeamsServiceHandler) UpdateTeam(context.Context, *connect_go.Request[v1.UpdateTeamRequest]) (*connect_go.Response[v1.UpdateTeamResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("gitpod.experimental.v1.TeamsService.UpdateTeam is not implemented"))
}
