...
func (s *ProxyWorkspacesServiceHandler) SetWorkspaceDescription(ctx context.Context, req *connect_go.Request[v1.SetWorkspaceDescriptionRequest]) (*connect_go.Response[v1.SetWorkspaceDescriptionResponse], error) {
	resp, err := s.Client.SetWorkspaceDescription(ctx, req.Msg)
	if err != nil {
		// TODO(milan): Convert to correct status code
		return nil, err
	}
