...
type PrebuildServiceClient interface {
	...
	GetPrebuildLogUrl(context.Context, *connect_go.Request[v1.GetPrebuildLogUrlRequest]) (*connect_go.Response[v1.GetPrebuildLogUrlResponse], error)
...
func NewPrebuildServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) PrebuildServiceClient {
	...
	return &prebuildServiceClient{
		...
		getPrebuildLogUrl: connect_go.NewClient[v1.GetPrebuildLogUrlRequest, v1.GetPrebuildLogUrlResponse](
			httpClient,
			baseURL+"/gitpod.v1.PrebuildService/GetPrebuildLogUrl",
			opts...,
		),
...
type prebuildServiceClient struct {
	...
	getPrebuildLogUrl         *connect_go.Client[v1.GetPrebuildLogUrlRequest, v1.GetPrebuildLogUrlResponse]
...
// GetPrebuildLogUrl calls gitpod.v1.PrebuildService.GetPrebuildLogUrl.
func (c *prebuildServiceClient) GetPrebuildLogUrl(ctx context.Context, req *connect_go.Request[v1.GetPrebuildLogUrlRequest]) (*connect_go.Response[v1.GetPrebuildLogUrlResponse], error) {
	return c.getPrebuildLogUrl.CallUnary(ctx, req)
}
...
func NewPrebuildServiceHandler(svc PrebuildServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/gitpod.v1.PrebuildService/GetPrebuildLogUrl", connect_go.NewUnaryHandler(
		"/gitpod.v1.PrebuildService/GetPrebuildLogUrl",
		svc.GetPrebuildLogUrl,
		opts...,
	))
...
func (UnimplementedPrebuildServiceHandler) GetPrebuildLogUrl(context.Context, *connect_go.Request[v1.GetPrebuildLogUrlRequest]) (*connect_go.Response[v1.GetPrebuildLogUrlResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("gitpod.v1.PrebuildService.GetPrebuildLogUrl is not implemented"))
}
