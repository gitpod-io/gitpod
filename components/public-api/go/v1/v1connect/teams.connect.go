...
const (
	...
	TeamsServiceName = "gitpod.v1.TeamsService"
)

// TeamsServiceClient is a client for the gitpod.v1.TeamsService service.
...
// NewTeamsServiceClient constructs a client for the gitpod.v1.TeamsService service. By default, it
...
func NewTeamsServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) TeamsServiceClient {
	...
	return &teamsServiceClient{
		createTeam: connect_go.NewClient[v1.CreateTeamRequest, v1.CreateTeamResponse](
			httpClient,
			baseURL+"/gitpod.v1.TeamsService/CreateTeam",
			opts...,
		),
	}
}
...
// CreateTeam calls gitpod.v1.TeamsService.CreateTeam.
...
// TeamsServiceHandler is an implementation of the gitpod.v1.TeamsService service.
...
func NewTeamsServiceHandler(svc TeamsServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/gitpod.v1.TeamsService/CreateTeam", connect_go.NewUnaryHandler(
		"/gitpod.v1.TeamsService/CreateTeam",
		svc.CreateTeam,
		opts...,
	))
	return "/gitpod.v1.TeamsService/", mux
}
...
func (UnimplementedTeamsServiceHandler) CreateTeam(context.Context, *connect_go.Request[v1.CreateTeamRequest]) (*connect_go.Response[v1.CreateTeamResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("gitpod.v1.TeamsService.CreateTeam is not implemented"))
}
