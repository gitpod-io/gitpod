...
type GitInitializer struct {
	...
	//
	// Deprecated: Do not use.
	Rivision string `protobuf:"bytes,7,opt,name=rivision,proto3" json:"rivision,omitempty"`
}
...
// Deprecated: Do not use.
func (x *GitInitializer) GetRivision() string {
	if x != nil {
		return x.Rivision
	}
	return ""
...
var file_gitpod_v1_workspace_proto_rawDesc = []byte{
	...
	0x1e, 0x0a, 0x08, 0x72, 0x69, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x07, 0x20, 0x01, 0x28,
	0x09, 0x42, 0x02, 0x18, 0x01, 0x52, 0x08, 0x72, 0x69, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x1a,
