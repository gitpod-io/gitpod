...
const (
	...
	PrebuildsServiceName = "gitpod.stable.v1.PrebuildsService"
)

// PrebuildsServiceClient is a client for the gitpod.stable.v1.PrebuildsService service.
...
// NewPrebuildsServiceClient constructs a client for the gitpod.stable.v1.PrebuildsService service.
...
// GetPrebuild calls gitpod.stable.v1.PrebuildsService.GetPrebuild.
...
// GetRunningPrebuild calls gitpod.stable.v1.PrebuildsService.GetRunningPrebuild.
...
// ListenToPrebuildStatus calls gitpod.stable.v1.PrebuildsService.ListenToPrebuildStatus.
...
// ListenToPrebuildLogs calls gitpod.stable.v1.PrebuildsService.ListenToPrebuildLogs.
...
// PrebuildsServiceHandler is an implementation of the gitpod.stable.v1.PrebuildsService service.
...
func NewPrebuildsServiceHandler(svc PrebuildsServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/gitpod.stable.v1.PrebuildsService/GetPrebuild", connect_go.NewUnaryHandler(
		"/gitpod.stable.v1.PrebuildsService/GetPrebuild",
		svc.GetPrebuild,
		opts...,
	))
	mux.Handle("/gitpod.stable.v1.PrebuildsService/GetRunningPrebuild", connect_go.NewUnaryHandler(
		"/gitpod.stable.v1.PrebuildsService/GetRunningPrebuild",
		svc.GetRunningPrebuild,
		opts...,
	))
	mux.Handle("/gitpod.stable.v1.PrebuildsService/ListenToPrebuildStatus", connect_go.NewServerStreamHandler(
		"/gitpod.stable.v1.PrebuildsService/ListenToPrebuildStatus",
		svc.ListenToPrebuildStatus,
		opts...,
	))
	mux.Handle("/gitpod.stable.v1.PrebuildsService/ListenToPrebuildLogs", connect_go.NewServerStreamHandler(
		"/gitpod.stable.v1.PrebuildsService/ListenToPrebuildLogs",
		svc.ListenToPrebuildLogs,
		opts...,
	))
	return "/gitpod.stable.v1.PrebuildsService/", mux
}
...
func (UnimplementedPrebuildsServiceHandler) GetPrebuild(context.Context, *connect_go.Request[v1.GetPrebuildRequest]) (*connect_go.Response[v1.GetPrebuildResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("gitpod.stable.v1.PrebuildsService.GetPrebuild is not implemented"))
}
...
func (UnimplementedPrebuildsServiceHandler) GetRunningPrebuild(context.Context, *connect_go.Request[v1.GetRunningPrebuildRequest]) (*connect_go.Response[v1.GetRunningPrebuildResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("gitpod.stable.v1.PrebuildsService.GetRunningPrebuild is not implemented"))
}
...
func (UnimplementedPrebuildsServiceHandler) ListenToPrebuildStatus(context.Context, *connect_go.Request[v1.ListenToPrebuildStatusRequest], *connect_go.ServerStream[v1.ListenToPrebuildStatusResponse]) error {
	return connect_go.NewError(connect_go.CodeUnimplemented, errors.New("gitpod.stable.v1.PrebuildsService.ListenToPrebuildStatus is not implemented"))
}
...
func (UnimplementedPrebuildsServiceHandler) ListenToPrebuildLogs(context.Context, *connect_go.Request[v1.ListenToPrebuildLogsRequest], *connect_go.ServerStream[v1.ListenToPrebuildLogsResponse]) error {
	return connect_go.NewError(connect_go.CodeUnimplemented, errors.New("gitpod.stable.v1.PrebuildsService.ListenToPrebuildLogs is not implemented"))
}
