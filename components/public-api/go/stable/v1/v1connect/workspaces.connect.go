...
const (
	...
	WorkspacesServiceName = "gitpod.stable.v1.WorkspacesService"
)

// WorkspacesServiceClient is a client for the gitpod.stable.v1.WorkspacesService service.
...
// NewWorkspacesServiceClient constructs a client for the gitpod.stable.v1.WorkspacesService
...
func NewWorkspacesServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) WorkspacesServiceClient {
	...
	return &workspacesServiceClient{
		...
		getActiveWorkspaceInstance: connect_go.NewClient[v1.GetActiveWorkspaceInstanceRequest, v1.GetActiveWorkspaceInstanceResponse](
			httpClient,
			baseURL+"/gitpod.stable.v1.WorkspacesService/GetActiveWorkspaceInstance",
			opts...,
		),
...
// ListWorkspaces calls gitpod.stable.v1.WorkspacesService.ListWorkspaces.
...
// GetWorkspace calls gitpod.stable.v1.WorkspacesService.GetWorkspace.
...
// GetOwnerToken calls gitpod.stable.v1.WorkspacesService.GetOwnerToken.
...
// CreateAndStartWorkspace calls gitpod.stable.v1.WorkspacesService.CreateAndStartWorkspace.
...
// StartWorkspace calls gitpod.stable.v1.WorkspacesService.StartWorkspace.
...
// GetActiveWorkspaceInstance calls gitpod.stable.v1.WorkspacesService.GetActiveWorkspaceInstance.
...
// GetWorkspaceInstanceOwnerToken calls
// gitpod.stable.v1.WorkspacesService.GetWorkspaceInstanceOwnerToken.
...
// ListenToWorkspaceInstance calls gitpod.stable.v1.WorkspacesService.ListenToWorkspaceInstance.
...
// ListenToImageBuildLogs calls gitpod.stable.v1.WorkspacesService.ListenToImageBuildLogs.
...
// StopWorkspace calls gitpod.stable.v1.WorkspacesService.StopWorkspace.
...
// WorkspacesServiceHandler is an implementation of the gitpod.stable.v1.WorkspacesService service.
...
func NewWorkspacesServiceHandler(svc WorkspacesServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/gitpod.stable.v1.WorkspacesService/ListWorkspaces", connect_go.NewUnaryHandler(
		"/gitpod.stable.v1.WorkspacesService/ListWorkspaces",
		svc.ListWorkspaces,
		opts...,
	))
	mux.Handle("/gitpod.stable.v1.WorkspacesService/GetWorkspace", connect_go.NewUnaryHandler(
		"/gitpod.stable.v1.WorkspacesService/GetWorkspace",
		svc.GetWorkspace,
		opts...,
	))
	mux.Handle("/gitpod.stable.v1.WorkspacesService/GetOwnerToken", connect_go.NewUnaryHandler(
		"/gitpod.stable.v1.WorkspacesService/GetOwnerToken",
		svc.GetOwnerToken,
		opts...,
	))
	mux.Handle("/gitpod.stable.v1.WorkspacesService/CreateAndStartWorkspace", connect_go.NewUnaryHandler(
		"/gitpod.stable.v1.WorkspacesService/CreateAndStartWorkspace",
		svc.CreateAndStartWorkspace,
		opts...,
	))
	mux.Handle("/gitpod.stable.v1.WorkspacesService/StartWorkspace", connect_go.NewUnaryHandler(
		"/gitpod.stable.v1.WorkspacesService/StartWorkspace",
		svc.StartWorkspace,
		opts...,
	))
	mux.Handle("/gitpod.stable.v1.WorkspacesService/GetActiveWorkspaceInstance", connect_go.NewUnaryHandler(
		"/gitpod.stable.v1.WorkspacesService/GetActiveWorkspaceInstance",
		svc.GetActiveWorkspaceInstance,
		opts...,
	))
	mux.Handle("/gitpod.stable.v1.WorkspacesService/GetWorkspaceInstanceOwnerToken", connect_go.NewUnaryHandler(
		"/gitpod.stable.v1.WorkspacesService/GetWorkspaceInstanceOwnerToken",
		svc.GetWorkspaceInstanceOwnerToken,
		opts...,
	))
	mux.Handle("/gitpod.stable.v1.WorkspacesService/ListenToWorkspaceInstance", connect_go.NewServerStreamHandler(
		"/gitpod.stable.v1.WorkspacesService/ListenToWorkspaceInstance",
		svc.ListenToWorkspaceInstance,
		opts...,
	))
	mux.Handle("/gitpod.stable.v1.WorkspacesService/ListenToImageBuildLogs", connect_go.NewServerStreamHandler(
		"/gitpod.stable.v1.WorkspacesService/ListenToImageBuildLogs",
		svc.ListenToImageBuildLogs,
		opts...,
	))
	mux.Handle("/gitpod.stable.v1.WorkspacesService/StopWorkspace", connect_go.NewServerStreamHandler(
		"/gitpod.stable.v1.WorkspacesService/StopWorkspace",
		svc.StopWorkspace,
		opts...,
	))
	return "/gitpod.stable.v1.WorkspacesService/", mux
}
...
func (UnimplementedWorkspacesServiceHandler) ListWorkspaces(context.Context, *connect_go.Request[v1.ListWorkspacesRequest]) (*connect_go.Response[v1.ListWorkspacesResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("gitpod.stable.v1.WorkspacesService.ListWorkspaces is not implemented"))
}
...
func (UnimplementedWorkspacesServiceHandler) GetWorkspace(context.Context, *connect_go.Request[v1.GetWorkspaceRequest]) (*connect_go.Response[v1.GetWorkspaceResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("gitpod.stable.v1.WorkspacesService.GetWorkspace is not implemented"))
}
...
func (UnimplementedWorkspacesServiceHandler) GetOwnerToken(context.Context, *connect_go.Request[v1.GetOwnerTokenRequest]) (*connect_go.Response[v1.GetOwnerTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("gitpod.stable.v1.WorkspacesService.GetOwnerToken is not implemented"))
}
...
func (UnimplementedWorkspacesServiceHandler) CreateAndStartWorkspace(context.Context, *connect_go.Request[v1.CreateAndStartWorkspaceRequest]) (*connect_go.Response[v1.CreateAndStartWorkspaceResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("gitpod.stable.v1.WorkspacesService.CreateAndStartWorkspace is not implemented"))
}
...
func (UnimplementedWorkspacesServiceHandler) StartWorkspace(context.Context, *connect_go.Request[v1.StartWorkspaceRequest]) (*connect_go.Response[v1.StartWorkspaceResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("gitpod.stable.v1.WorkspacesService.StartWorkspace is not implemented"))
}
...
func (UnimplementedWorkspacesServiceHandler) GetActiveWorkspaceInstance(context.Context, *connect_go.Request[v1.GetActiveWorkspaceInstanceRequest]) (*connect_go.Response[v1.GetActiveWorkspaceInstanceResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("gitpod.stable.v1.WorkspacesService.GetActiveWorkspaceInstance is not implemented"))
}
...
func (UnimplementedWorkspacesServiceHandler) GetWorkspaceInstanceOwnerToken(context.Context, *connect_go.Request[v1.GetWorkspaceInstanceOwnerTokenRequest]) (*connect_go.Response[v1.GetWorkspaceInstanceOwnerTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("gitpod.stable.v1.WorkspacesService.GetWorkspaceInstanceOwnerToken is not implemented"))
}
...
func (UnimplementedWorkspacesServiceHandler) ListenToWorkspaceInstance(context.Context, *connect_go.Request[v1.ListenToWorkspaceInstanceRequest], *connect_go.ServerStream[v1.ListenToWorkspaceInstanceResponse]) error {
	return connect_go.NewError(connect_go.CodeUnimplemented, errors.New("gitpod.stable.v1.WorkspacesService.ListenToWorkspaceInstance is not implemented"))
}
...
func (UnimplementedWorkspacesServiceHandler) ListenToImageBuildLogs(context.Context, *connect_go.Request[v1.ListenToImageBuildLogsRequest], *connect_go.ServerStream[v1.ListenToImageBuildLogsResponse]) error {
	return connect_go.NewError(connect_go.CodeUnimplemented, errors.New("gitpod.stable.v1.WorkspacesService.ListenToImageBuildLogs is not implemented"))
}
...
func (UnimplementedWorkspacesServiceHandler) StopWorkspace(context.Context, *connect_go.Request[v1.StopWorkspaceRequest], *connect_go.ServerStream[v1.StopWorkspaceResponse]) error {
	return connect_go.NewError(connect_go.CodeUnimplemented, errors.New("gitpod.stable.v1.WorkspacesService.StopWorkspace is not implemented"))
}
