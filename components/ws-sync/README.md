...
### Tracing / Jaeger
`ws-sync` has OpenTracing instrumentation which means you can get traces out of ws-sync.
At the moment we just print the traces as log messages. If you want to run ws-sync with a remote
