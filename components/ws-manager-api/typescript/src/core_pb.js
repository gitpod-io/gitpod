...
goog.exportSymbol('proto.wsman.SubscribeResponse.PayloadCase', null, global);
...
proto.wsman.SubscribeResponse.prototype.setStatus = function(value) {
  return jspb.Message.setOneofWrapperField(this, 1, proto.wsman.SubscribeResponse.oneofGroups_[0], value);
};
...
proto.wsman.SubscribeResponse.prototype.setLog = function(value) {
  return jspb.Message.setOneofWrapperField(this, 2, proto.wsman.SubscribeResponse.oneofGroups_[0], value);
};
...
proto.wsman.WorkspaceConditions.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    prebuildTaskFailed: jspb.Message.getFieldWithDefault(msg, 10, 0)
  };
...
proto.wsman.WorkspaceConditions.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 10:
      var value = /** @type {!proto.wsman.WorkspaceConditionBool} */ (reader.readEnum());
      msg.setPrebuildTaskFailed(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.wsman.WorkspaceConditions.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getPrebuildTaskFailed();
  if (f !== 0.0) {
    writer.writeEnum(
      10,
      f
...
/**
 * optional WorkspaceConditionBool prebuild_task_failed = 10;
 * @return {!proto.wsman.WorkspaceConditionBool}
 */
proto.wsman.WorkspaceConditions.prototype.getPrebuildTaskFailed = function() {
  return /** @type {!proto.wsman.WorkspaceConditionBool} */ (jspb.Message.getFieldWithDefault(this, 10, 0));
};
 ...
 * @return {!proto.wsman.WorkspaceConditions} returns this
 */
proto.wsman.WorkspaceConditions.prototype.setPrebuildTaskFailed = function(value) {
...
/**
 * @param {string} value
 * @return {!proto.wsman.WorkspaceLogMessage} returns this
 */
