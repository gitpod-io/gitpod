...
goog.object.extend(proto, image$builder$api_imgbuilder_pb);
...
goog.exportSymbol('proto.wsman.WorkspaceImageStatus.LogInfo', null, global);
goog.exportSymbol('proto.wsman.WorkspaceImageStatus.Phase', null, global);
 ...
 * @constructor
 */
proto.wsman.WorkspaceImageStatus.LogInfo = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.wsman.WorkspaceImageStatus.LogInfo, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.wsman.WorkspaceImageStatus.LogInfo.displayName = 'proto.wsman.WorkspaceImageStatus.LogInfo';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.wsman.WorkspaceImageStatus.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    baseRef: jspb.Message.getFieldWithDefault(msg, 2, ""),
    imageRef: jspb.Message.getFieldWithDefault(msg, 3, ""),
    logs: (f = msg.getLogs()) && proto.wsman.WorkspaceImageStatus.LogInfo.toObject(includeInstance, f)
  };
...
proto.wsman.WorkspaceImageStatus.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.wsman.WorkspaceImageStatus.Phase} */ (reader.readEnum());
      msg.setPhase(value);
      break;
    case 2:
      var value = /** @type {string} */ (reader.readString());
    ...
    case 3:
      ...
      break;
    case 4:
      var value = new proto.wsman.WorkspaceImageStatus.LogInfo;
      reader.readMessage(value,proto.wsman.WorkspaceImageStatus.LogInfo.deserializeBinaryFromReader);
      msg.setLogs(value);
      break;
    default:
      reader.skipField();
...
proto.wsman.WorkspaceImageStatus.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      proto.wsman.WorkspaceImageStatus.LogInfo.serializeBinaryToWriter
    );
  }
};
 ...
 * @enum {number}
 */
proto.wsman.WorkspaceImageStatus.Phase = {
  UNAVAILABLE: 0,
  BUILDING: 1,
  AVAILABLE: 2
};
 ...
 * @return {!Object}
 */
proto.wsman.WorkspaceImageStatus.LogInfo.prototype.toObject = function(opt_includeInstance) {
  return proto.wsman.WorkspaceImageStatus.LogInfo.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.wsman.WorkspaceImageStatus.LogInfo} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.wsman.WorkspaceImageStatus.LogInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
    url: jspb.Message.getFieldWithDefault(msg, 1, ""),
    headerMap: (f = msg.getHeaderMap()) ? f.toObject(includeInstance, undefined) : []
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.wsman.WorkspaceImageStatus.LogInfo}
 */
proto.wsman.WorkspaceImageStatus.LogInfo.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.wsman.WorkspaceImageStatus.LogInfo;
  return proto.wsman.WorkspaceImageStatus.LogInfo.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.wsman.WorkspaceImageStatus.LogInfo} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.wsman.WorkspaceImageStatus.LogInfo}
 */
proto.wsman.WorkspaceImageStatus.LogInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.wsman.WorkspaceImageStatus.LogInfo.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.wsman.WorkspaceImageStatus.LogInfo.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.wsman.WorkspaceImageStatus.LogInfo} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.wsman.WorkspaceImageStatus.LogInfo.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUrl();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.wsman.WorkspaceImageStatus.LogInfo.prototype.getUrl = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.wsman.WorkspaceImageStatus.LogInfo} returns this
 */
proto.wsman.WorkspaceImageStatus.LogInfo.prototype.setUrl = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!jspb.Map<string,string>}
 */
proto.wsman.WorkspaceImageStatus.LogInfo.prototype.getHeaderMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,string>} */ (
 ...
 * @return {!proto.wsman.WorkspaceImageStatus.LogInfo} returns this
 */
proto.wsman.WorkspaceImageStatus.LogInfo.prototype.clearHeaderMap = function() {
  this.getHeaderMap().clear();
  return this;};
 ...
 * @return {!proto.wsman.WorkspaceImageStatus.Phase}
 */
proto.wsman.WorkspaceImageStatus.prototype.getPhase = function() {
  return /** @type {!proto.wsman.WorkspaceImageStatus.Phase} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.wsman.WorkspaceImageStatus.Phase} value
...
/**
 * optional string base_ref = 2;
 * @return {string}
 */
proto.wsman.WorkspaceImageStatus.prototype.getBaseRef = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.wsman.WorkspaceImageStatus} returns this
 */
proto.wsman.WorkspaceImageStatus.prototype.setBaseRef = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.wsman.WorkspaceImageStatus.prototype.getImageRef = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.wsman.WorkspaceImageStatus} returns this
 */
proto.wsman.WorkspaceImageStatus.prototype.setImageRef = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};


/**
 * optional LogInfo logs = 4;
 * @return {?proto.wsman.WorkspaceImageStatus.LogInfo}
 */
proto.wsman.WorkspaceImageStatus.prototype.getLogs = function() {
  return /** @type{?proto.wsman.WorkspaceImageStatus.LogInfo} */ (
    jspb.Message.getWrapperField(this, proto.wsman.WorkspaceImageStatus.LogInfo, 4));
};


/**
 * @param {?proto.wsman.WorkspaceImageStatus.LogInfo|undefined} value
 * @return {!proto.wsman.WorkspaceImageStatus} returns this
*/
...
proto.wsman.StartWorkspaceSpec.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    ideImage: (f = msg.getIdeImage()) && proto.wsman.IDEImage.toObject(includeInstance, f),
    workspaceImageBuild: (f = msg.getWorkspaceImageBuild()) && image$builder$api_imgbuilder_pb.BuildRequest.toObject(includeInstance, f)
  };
...
proto.wsman.StartWorkspaceSpec.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 12:
      ...
      break;
    case 13:
      var value = new image$builder$api_imgbuilder_pb.BuildRequest;
      reader.readMessage(value,image$builder$api_imgbuilder_pb.BuildRequest.deserializeBinaryFromReader);
      msg.setWorkspaceImageBuild(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.wsman.StartWorkspaceSpec.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getWorkspaceImageBuild();
  if (f != null) {
    writer.writeMessage(
      13,
      f,
      image$builder$api_imgbuilder_pb.BuildRequest.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional builder.BuildRequest workspace_image_build = 13;
 * @return {?proto.builder.BuildRequest}
 */
proto.wsman.StartWorkspaceSpec.prototype.getWorkspaceImageBuild = function() {
  return /** @type{?proto.builder.BuildRequest} */ (
    jspb.Message.getWrapperField(this, image$builder$api_imgbuilder_pb.BuildRequest, 13));
};


/**
 * @param {?proto.builder.BuildRequest|undefined} value
 * @return {!proto.wsman.StartWorkspaceSpec} returns this
*/
proto.wsman.StartWorkspaceSpec.prototype.setWorkspaceImageBuild = function(value) {
 ...
 * @return {!proto.wsman.StartWorkspaceSpec} returns this
 */
proto.wsman.StartWorkspaceSpec.prototype.clearWorkspaceImageBuild = function() {
  return this.setWorkspaceImageBuild(undefined);
};
 ...
 * @return {boolean}
 */
proto.wsman.StartWorkspaceSpec.prototype.hasWorkspaceImageBuild = function() {
