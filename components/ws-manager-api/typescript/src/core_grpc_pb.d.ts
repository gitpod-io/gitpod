...
interface IWorkspaceManagerService_IGetVolumeSnapshot
    extends grpc.MethodDefinition<core_pb.GetVolumeSnapshotRequest, core_pb.GetVolumeSnapshotResponse> {
...
export interface IWorkspaceManagerClient {
    ...
    getVolumeSnapshot(
        request: core_pb.GetVolumeSnapshotRequest,
        callback: (error: grpc.ServiceError | null, response: core_pb.GetVolumeSnapshotResponse) => void,
    ): grpc.ClientUnaryCall;
    getVolumeSnapshot(
        request: core_pb.GetVolumeSnapshotRequest,
        metadata: grpc.Metadata,
