...
interface IWorkspaceManagerService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
    ...
    restartRing1: IWorkspaceManagerService_IRestartRing1;
}
...
interface IWorkspaceManagerService_IRestartRing1 extends grpc.MethodDefinition<core_pb.RestartRing1Request, core_pb.RestartRing1Response> {
    path: "/wsman.WorkspaceManager/RestartRing1";
    requestStream: false;
    responseStream: false;
    requestSerialize: grpc.serialize<core_pb.RestartRing1Request>;
    requestDeserialize: grpc.deserialize<core_pb.RestartRing1Request>;
    responseSerialize: grpc.serialize<core_pb.RestartRing1Response>;
    responseDeserialize: grpc.deserialize<core_pb.RestartRing1Response>;
}
...
export interface IWorkspaceManagerServer extends grpc.UntypedServiceImplementation {
    ...
    restartRing1: grpc.handleUnaryCall<core_pb.RestartRing1Request, core_pb.RestartRing1Response>;
}
...
export interface IWorkspaceManagerClient {
    ...
    restartRing1(request: core_pb.RestartRing1Request, callback: (error: grpc.ServiceError | null, response: core_pb.RestartRing1Response) => void): grpc.ClientUnaryCall;
    restartRing1(request: core_pb.RestartRing1Request, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: core_pb.RestartRing1Response) => void): grpc.ClientUnaryCall;
    restartRing1(request: core_pb.RestartRing1Request, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: core_pb.RestartRing1Response) => void): grpc.ClientUnaryCall;
}
...
export class WorkspaceManagerClient extends grpc.Client implements IWorkspaceManagerClient {
    ...
    public restartRing1(request: core_pb.RestartRing1Request, callback: (error: grpc.ServiceError | null, response: core_pb.RestartRing1Response) => void): grpc.ClientUnaryCall;
    public restartRing1(request: core_pb.RestartRing1Request, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: core_pb.RestartRing1Response) => void): grpc.ClientUnaryCall;
    public restartRing1(request: core_pb.RestartRing1Request, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: core_pb.RestartRing1Response) => void): grpc.ClientUnaryCall;
}
