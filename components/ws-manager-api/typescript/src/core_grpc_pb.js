...
function serialize_wsman_CheckVolumeSnapshotIsReadyRequest(arg) {
    if (!(arg instanceof core_pb.CheckVolumeSnapshotIsReadyRequest)) {
        throw new Error("Expected argument of type wsman.CheckVolumeSnapshotIsReadyRequest");
    }
    return Buffer.from(arg.serializeBinary());
}

function deserialize_wsman_CheckVolumeSnapshotIsReadyRequest(buffer_arg) {
    return core_pb.CheckVolumeSnapshotIsReadyRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_wsman_CheckVolumeSnapshotIsReadyResponse(arg) {
    if (!(arg instanceof core_pb.CheckVolumeSnapshotIsReadyResponse)) {
        throw new Error("Expected argument of type wsman.CheckVolumeSnapshotIsReadyResponse");
    }
    return Buffer.from(arg.serializeBinary());
}

function deserialize_wsman_CheckVolumeSnapshotIsReadyResponse(buffer_arg) {
    return core_pb.CheckVolumeSnapshotIsReadyResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
