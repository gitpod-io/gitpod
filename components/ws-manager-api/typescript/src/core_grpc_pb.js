...
function serialize_wsman_RestartRing1Request(arg) {
  if (!(arg instanceof core_pb.RestartRing1Request)) {
    throw new Error('Expected argument of type wsman.RestartRing1Request');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_wsman_RestartRing1Request(buffer_arg) {
  return core_pb.RestartRing1Request.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_wsman_RestartRing1Response(arg) {
  if (!(arg instanceof core_pb.RestartRing1Response)) {
    throw new Error('Expected argument of type wsman.RestartRing1Response');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_wsman_RestartRing1Response(buffer_arg) {
  return core_pb.RestartRing1Response.deserializeBinary(new Uint8Array(buffer_arg));
}
...
restartRing1: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: core_pb.RestartRing1Request,
    responseType: core_pb.RestartRing1Response,
    requestSerialize: serialize_wsman_RestartRing1Request,
    requestDeserialize: deserialize_wsman_RestartRing1Request,
    responseSerialize: serialize_wsman_RestartRing1Response,
    responseDeserialize: deserialize_wsman_RestartRing1Response,
  },
};
