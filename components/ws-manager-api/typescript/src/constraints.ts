...
const workspaceClusterSets: WorkspaceClusterConstraintSet[] = [
    ...
    },
    {
        ...
        constraint: intersect(constraintRegional, constraintMoreResources),
    },
    {
        name: 'regional regular',
        constraint: intersect(constraintRegional, constraintInverseMoreResources),
    },
    {
        name: 'non-regional more resources',
        constraint: intersect(invert(constraintRegional), constraintMoreResources),
    },
    {
        name: 'non-regional non-paying',
        constraint: intersect(invert(constraintRegional), constraintInverseMoreResources),
    },
];
...
export function constraintInverseMoreResources(
    all: WorkspaceClusterWoTLS[],
    user: ExtendedUser,
    workspace: Workspace,
    instance: WorkspaceInstance,
    ...
    return all.filter(
        (cluster) => !cluster.admissionConstraints?.find((constraint) => constraint.type === 'has-more-resources'),
    );
}

export function constraintMoreResources(
    all: WorkspaceClusterWoTLS[],
    user: ExtendedUser,
    workspace: Workspace,
    instance: WorkspaceInstance,
