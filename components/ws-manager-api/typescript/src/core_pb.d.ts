...
export class WorkspaceConditions extends jspb.Message {
    ...
    getPrebuildTaskFailed(): WorkspaceConditionBool;
    setPrebuildTaskFailed(value: WorkspaceConditionBool): WorkspaceConditions;
...
export namespace WorkspaceConditions {
    export type AsObject = {
        ...
        prebuildTaskFailed: WorkspaceConditionBool,
    }
}
