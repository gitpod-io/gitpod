...
import (
	...
	api1 "github.com/gitpod-io/gitpod/image-builder/api"
...
const (
	...
	// BuildingImage means the workspace currently has its workspace image built. In this time the workspace isn't
	// actually starting, but instead we're building its image.
...
// Phase marks the phase of a workspace image
type WorkspaceImageStatus_Phase int32

const (
	WorkspaceImageStatus_UNAVAILABLE WorkspaceImageStatus_Phase = 0
	WorkspaceImageStatus_BUILDING    WorkspaceImageStatus_Phase = 1
	WorkspaceImageStatus_AVAILABLE   WorkspaceImageStatus_Phase = 2
)

// Enum value maps for WorkspaceImageStatus_Phase.
var (
	WorkspaceImageStatus_Phase_name = map[int32]string{
		0: "UNAVAILABLE",
		1: "BUILDING",
		2: "AVAILABLE",
	}
	WorkspaceImageStatus_Phase_value = map[string]int32{
		"UNAVAILABLE": 0,
		"BUILDING":    1,
		"AVAILABLE":   2,
	}
...
func (x WorkspaceImageStatus_Phase) Enum() *WorkspaceImageStatus_Phase {
	p := new(WorkspaceImageStatus_Phase)
	*p = x
	return p
}

func (x WorkspaceImageStatus_Phase) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (WorkspaceImageStatus_Phase) Descriptor() protoreflect.EnumDescriptor {
	return file_core_proto_enumTypes[7].Descriptor()
}

func (WorkspaceImageStatus_Phase) Type() protoreflect.EnumType {
	return &file_core_proto_enumTypes[7]
}

func (x WorkspaceImageStatus_Phase) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use WorkspaceImageStatus_Phase.Descriptor instead.
func (WorkspaceImageStatus_Phase) EnumDescriptor() ([]byte, []int) {
...
type WorkspaceStatus struct {
	...
	// WorkspaceImageStatus provides information about the workspace image
...
type WorkspaceImageStatus struct {
	...
	// Phase marks the phase of a workspace image
	Phase WorkspaceImageStatus_Phase `protobuf:"varint,1,opt,name=phase,proto3,enum=wsman.WorkspaceImageStatus_Phase" json:"phase,omitempty"`
	// BaseRef is the workspace image base reference
	BaseRef string `protobuf:"bytes,2,opt,name=base_ref,json=baseRef,proto3" json:"base_ref,omitempty"`
	// image_ref is the actual workspace image reference
	ImageRef string `protobuf:"bytes,3,opt,name=image_ref,json=imageRef,proto3" json:"image_ref,omitempty"`
	// logs provides access to the build logs when the phase is BUILDING
	Logs *WorkspaceImageStatus_LogInfo `protobuf:"bytes,4,opt,name=logs,proto3" json:"logs,omitempty"`
}
...
func (x *WorkspaceImageStatus) GetPhase() WorkspaceImageStatus_Phase {
	if x != nil {
		return x.Phase
	}
	return WorkspaceImageStatus_UNAVAILABLE
}

func (x *WorkspaceImageStatus) GetBaseRef() string {
	if x != nil {
		return x.BaseRef
	}
	return ""
...
func (x *WorkspaceImageStatus) GetImageRef() string {
	if x != nil {
		return x.ImageRef
	}
	return ""
...
func (x *WorkspaceImageStatus) GetLogs() *WorkspaceImageStatus_LogInfo {
	if x != nil {
		return x.Logs
	}
	return nil
...
type StartWorkspaceSpec struct {
	...
	// workspace_image_build is exclusive to the workspace_image. When set, there will be an image-build
	// which preceeds the workspace startup.
	WorkspaceImageBuild *api1.BuildRequest `protobuf:"bytes,13,opt,name=workspace_image_build,json=workspaceImageBuild,proto3" json:"workspace_image_build,omitempty"`
}
...
func (x *StartWorkspaceSpec) GetWorkspaceImageBuild() *api1.BuildRequest {
	if x != nil {
		return x.WorkspaceImageBuild
	}
	return nil
}
...
// LogInfo provides access to the image build logs
type WorkspaceImageStatus_LogInfo struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *WorkspaceImageStatus_LogInfo) Reset() {
	*x = WorkspaceImageStatus_LogInfo{}
	if protoimpl.UnsafeEnabled {
...
func (x *WorkspaceImageStatus_LogInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WorkspaceImageStatus_LogInfo) ProtoMessage() {}

func (x *WorkspaceImageStatus_LogInfo) ProtoReflect() protoreflect.Message {
	mi := &file_core_proto_msgTypes[38]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WorkspaceImageStatus_LogInfo.ProtoReflect.Descriptor instead.
func (*WorkspaceImageStatus_LogInfo) Descriptor() ([]byte, []int) {
	return file_core_proto_rawDescGZIP(), []int{25, 0}
}

func (x *WorkspaceImageStatus_LogInfo) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *WorkspaceImageStatus_LogInfo) GetHeader() map[string]string {
	if x != nil {
		return x.Header
	}
	return nil
...
func (*EnvironmentVariable_SecretKeyRef) Descriptor() ([]byte, []int) {
	return file_core_proto_rawDescGZIP(), []int{34, 0}
}
...
var file_core_proto_rawDesc = []byte{
	...
	0x69, 0x7a, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x22, 0x69, 0x6d, 0x61, 0x67,
	0x65, 0x2d, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x2d, 0x61, 0x70, 0x69, 0x2f, 0x69, 0x6d,
	0x67, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1f,
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f,
	0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22,
	0xc9, 0x01, 0x0a, 0x0e, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x46, 0x69, 0x6c, 0x74,
	...
	0x64, 0x12, 0x48, 0x0a, 0x0b, 0x61, 0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x77, 0x73, 0x6d, 0x61, 0x6e, 0x2e, 0x4d,
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x2e, 0x41, 0x6e,
	...
	,
	...
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x70, 0x72, 0x65, 0x66, 0x69, 0x78, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x50, 0x72, 0x65,
	0x66, 0x69, 0x78, 0x12, 0x34, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x77, 0x73, 0x6d, 0x61, 0x6e, 0x2e, 0x57, 0x6f,
	...
	0x63, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x77, 0x73, 0x6d, 0x61, 0x6e, 0x2e,
	0x53, 0x74, 0x61, 0x72, 0x74, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x53, 0x70,
	0x65, 0x63, 0x52, 0x04, 0x73, 0x70, 0x65, 0x63, 0x12, 0x28, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x77, 0x73, 0x6d, 0x61, 0x6e, 0x2e, 0x57,
	0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79,
	0x70, 0x65, 0x4a, 0x04, 0x08, 0x05, 0x10, 0x06, 0x22, 0x4b, 0x0a, 0x16, 0x53, 0x74, 0x61, 0x72,
	...
	0x03, 0x75, 0x72, 0x6c, 0x12, 0x1f, 0x0a, 0x0b, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x5f, 0x74, 0x6f,
	0x6b, 0x65, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x6f, 0x77, 0x6e, 0x65, 0x72,
	0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x5a, 0x0a, 0x14, 0x53, 0x74, 0x6f, 0x70, 0x57, 0x6f, 0x72,
	...
	,
	...
	,
	...
	0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x22, 0x3b, 0x0a, 0x11, 0x4d, 0x61, 0x72, 0x6b, 0x41, 0x63,
	0x74, 0x69, 0x76, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	,
	...
	0x52, 0x03, 0x75, 0x72, 0x6c, 0x22, 0xf8, 0x03, 0x0a, 0x0f, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70,
	...
	,
	...
	,
	...
	0x38, 0x01, 0x22, 0x35, 0x0a, 0x05, 0x50, 0x68, 0x61, 0x73, 0x65, 0x12, 0x0f, 0x0a, 0x0b, 0x55,
	0x4e, 0x41, 0x56, 0x41, 0x49, 0x4c, 0x41, 0x42, 0x4c, 0x45, 0x10, 0x00, 0x12, 0x0c, 0x0a, 0x08,
	0x42, 0x55, 0x49, 0x4c, 0x44, 0x49, 0x4e, 0x47, 0x10, 0x01, 0x12, 0x0d, 0x0a, 0x09, 0x41, 0x56,
	0x41, 0x49, 0x4c, 0x41, 0x42, 0x4c, 0x45, 0x10, 0x02, 0x22, 0xc0, 0x02, 0x0a, 0x0d, 0x57, 0x6f,
	...
	,
	...
	0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x12, 0x2c,
	0x0a, 0x09, 0x69, 0x64, 0x65, 0x5f, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x0f, 0x2e, 0x77, 0x73, 0x6d, 0x61, 0x6e, 0x2e, 0x49, 0x44, 0x45, 0x49, 0x6d, 0x61,
	0x67, 0x65, 0x52, 0x08, 0x69, 0x64, 0x65, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x22, 0x6d, 0x0a, 0x08,
	...
	0x52, 0x03, 0x75, 0x72, 0x6c, 0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x22, 0xd3, 0x04, 0x0a, 0x13,
	...
	,
	...
	,
	...
	0x0a, 0x14, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x52, 0x75, 0x6e, 0x74, 0x69,
	0x6d, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1b, 0x0a, 0x09, 0x6e, 0x6f, 0x64, 0x65, 0x5f, 0x6e,
	...
	,
	...
	0x0b, 0x32, 0x0f, 0x2e, 0x77, 0x73, 0x6d, 0x61, 0x6e, 0x2e, 0x49, 0x44, 0x45, 0x49, 0x6d, 0x61,
	0x67, 0x65, 0x52, 0x08, 0x69, 0x64, 0x65, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x12, 0x49, 0x0a, 0x15,
	0x77, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x5f, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x5f,
	0x62, 0x75, 0x69, 0x6c, 0x64, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x62, 0x75,
	0x69, 0x6c, 0x64, 0x65, 0x72, 0x2e, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x52, 0x13, 0x77, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x49, 0x6d, 0x61,
	0x67, 0x65, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x22, 0x3b, 0x0a, 0x07, 0x47, 0x69, 0x74, 0x53, 0x70,
	...
	,
	...
	0x05, 0x45, 0x4d, 0x50, 0x54, 0x59, 0x10, 0x02, 0x2a, 0x97, 0x01, 0x0a, 0x0e, 0x57, 0x6f, 0x72,
	...
	,
	...
	0x69, 0x74, 0x70, 0x6f, 0x64, 0x2f, 0x77, 0x73, 0x2d, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72,
...
var file_core_proto_goTypes = []interface{}{
	...
	(WorkspaceImageStatus_Phase)(0),          // 7: wsman.WorkspaceImageStatus.Phase
	...
	(*WorkspaceImageStatus)(nil),             // 33: wsman.WorkspaceImageStatus
	(*WorkspaceSpec)(nil),                    // 34: wsman.WorkspaceSpec
	(*PortSpec)(nil),                         // 35: wsman.PortSpec
	(*WorkspaceConditions)(nil),              // 36: wsman.WorkspaceConditions
	(*WorkspaceMetadata)(nil),                // 37: wsman.WorkspaceMetadata
	(*WorkspaceRuntimeInfo)(nil),             // 38: wsman.WorkspaceRuntimeInfo
	(*WorkspaceAuthentication)(nil),          // 39: wsman.WorkspaceAuthentication
	(*StartWorkspaceSpec)(nil),               // 40: wsman.StartWorkspaceSpec
	(*GitSpec)(nil),                          // 41: wsman.GitSpec
	(*EnvironmentVariable)(nil),              // 42: wsman.EnvironmentVariable
	(*ExposedPorts)(nil),                     // 43: wsman.ExposedPorts
	nil,                                      // 44: wsman.MetadataFilter.AnnotationsEntry
	nil,                                      // 45: wsman.SubscribeResponse.HeaderEntry
	(*WorkspaceImageStatus_LogInfo)(nil),     // 46: wsman.WorkspaceImageStatus.LogInfo
	nil,                                      // 47: wsman.WorkspaceImageStatus.LogInfo.HeaderEntry
	nil,                                      // 48: wsman.WorkspaceMetadata.AnnotationsEntry
	(*EnvironmentVariable_SecretKeyRef)(nil), // 49: wsman.EnvironmentVariable.SecretKeyRef
	(*api.GitStatus)(nil),                    // 50: contentservice.GitStatus
	(*timestamppb.Timestamp)(nil),            // 51: google.protobuf.Timestamp
	(*api.WorkspaceInitializer)(nil),         // 52: contentservice.WorkspaceInitializer
	(*api1.BuildRequest)(nil),                // 53: builder.BuildRequest
}
var file_core_proto_depIdxs = []int32{
	44, // 0: wsman.MetadataFilter.annotations:type_name -> wsman.MetadataFilter.AnnotationsEntry
	...
	37, // 3: wsman.StartWorkspaceRequest.metadata:type_name -> wsman.WorkspaceMetadata
	40, // 4: wsman.StartWorkspaceRequest.spec:type_name -> wsman.StartWorkspaceSpec
	...
	45, // 10: wsman.SubscribeResponse.header:type_name -> wsman.SubscribeResponse.HeaderEntry
	35, // 11: wsman.ControlPortRequest.spec:type_name -> wsman.PortSpec
	1,  // 12: wsman.ControlAdmissionRequest.level:type_name -> wsman.AdmissionLevel
	37, // 13: wsman.WorkspaceStatus.metadata:type_name -> wsman.WorkspaceMetadata
	34, // 14: wsman.WorkspaceStatus.spec:type_name -> wsman.WorkspaceSpec
	4,  // 15: wsman.WorkspaceStatus.phase:type_name -> wsman.WorkspacePhase
	36, // 16: wsman.WorkspaceStatus.conditions:type_name -> wsman.WorkspaceConditions
	50, // 17: wsman.WorkspaceStatus.repo:type_name -> contentservice.GitStatus
	38, // 18: wsman.WorkspaceStatus.runtime:type_name -> wsman.WorkspaceRuntimeInfo
	39, // 19: wsman.WorkspaceStatus.auth:type_name -> wsman.WorkspaceAuthentication
	33, // 20: wsman.WorkspaceStatus.image:type_name -> wsman.WorkspaceImageStatus
	7,  // 21: wsman.WorkspaceImageStatus.phase:type_name -> wsman.WorkspaceImageStatus.Phase
	46, // 22: wsman.WorkspaceImageStatus.logs:type_name -> wsman.WorkspaceImageStatus.LogInfo
	35, // 23: wsman.WorkspaceSpec.exposed_ports:type_name -> wsman.PortSpec
	6,  // 24: wsman.WorkspaceSpec.type:type_name -> wsman.WorkspaceType
	32, // 25: wsman.WorkspaceSpec.ide_image:type_name -> wsman.IDEImage
	2,  // 26: wsman.PortSpec.visibility:type_name -> wsman.PortVisibility
	3,  // 27: wsman.WorkspaceConditions.pulling_images:type_name -> wsman.WorkspaceConditionBool
	3,  // 28: wsman.WorkspaceConditions.final_backup_complete:type_name -> wsman.WorkspaceConditionBool
	3,  // 29: wsman.WorkspaceConditions.deployed:type_name -> wsman.WorkspaceConditionBool
	3,  // 30: wsman.WorkspaceConditions.network_not_ready:type_name -> wsman.WorkspaceConditionBool
	51, // 31: wsman.WorkspaceConditions.first_user_activity:type_name -> google.protobuf.Timestamp
	3,  // 32: wsman.WorkspaceConditions.stopped_by_request:type_name -> wsman.WorkspaceConditionBool
	51, // 33: wsman.WorkspaceMetadata.started_at:type_name -> google.protobuf.Timestamp
	48, // 34: wsman.WorkspaceMetadata.annotations:type_name -> wsman.WorkspaceMetadata.AnnotationsEntry
	...
	52, // 37: wsman.StartWorkspaceSpec.initializer:type_name -> contentservice.WorkspaceInitializer
	35, // 38: wsman.StartWorkspaceSpec.ports:type_name -> wsman.PortSpec
	42, // 39: wsman.StartWorkspaceSpec.envvars:type_name -> wsman.EnvironmentVariable
	41, // 40: wsman.StartWorkspaceSpec.git:type_name -> wsman.GitSpec
	1,  // 41: wsman.StartWorkspaceSpec.admission:type_name -> wsman.AdmissionLevel
	32, // 42: wsman.StartWorkspaceSpec.ide_image:type_name -> wsman.IDEImage
	53, // 43: wsman.StartWorkspaceSpec.workspace_image_build:type_name -> builder.BuildRequest
	49, // 44: wsman.EnvironmentVariable.secret:type_name -> wsman.EnvironmentVariable.SecretKeyRef
	35, // 45: wsman.ExposedPorts.ports:type_name -> wsman.PortSpec
	47, // 46: wsman.WorkspaceImageStatus.LogInfo.header:type_name -> wsman.WorkspaceImageStatus.LogInfo.HeaderEntry
	...
	29, // 51: wsman.WorkspaceManager.BackupWorkspace:input_type -> wsman.BackupWorkspaceRequest
	...
	10, // 58: wsman.WorkspaceManager.GetWorkspaces:output_type -> wsman.GetWorkspacesResponse
	12, // 59: wsman.WorkspaceManager.StartWorkspace:output_type -> wsman.StartWorkspaceResponse
	14, // 60: wsman.WorkspaceManager.StopWorkspace:output_type -> wsman.StopWorkspaceResponse
	16, // 61: wsman.WorkspaceManager.DescribeWorkspace:output_type -> wsman.DescribeWorkspaceResponse
	30, // 62: wsman.WorkspaceManager.BackupWorkspace:output_type -> wsman.BackupWorkspaceResponse
	18, // 63: wsman.WorkspaceManager.Subscribe:output_type -> wsman.SubscribeResponse
	20, // 64: wsman.WorkspaceManager.MarkActive:output_type -> wsman.MarkActiveResponse
	22, // 65: wsman.WorkspaceManager.SetTimeout:output_type -> wsman.SetTimeoutResponse
	24, // 66: wsman.WorkspaceManager.ControlPort:output_type -> wsman.ControlPortResponse
	26, // 67: wsman.WorkspaceManager.TakeSnapshot:output_type -> wsman.TakeSnapshotResponse
	28, // 68: wsman.WorkspaceManager.ControlAdmission:output_type -> wsman.ControlAdmissionResponse
...
func file_core_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_core_proto_msgTypes[38].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WorkspaceImageStatus_LogInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
