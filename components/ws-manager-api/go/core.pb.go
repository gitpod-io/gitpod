...
// WorkspaceImagePhase covers the current phase of the workspace image
type WorkspaceImagePhase int32

const (
	WorkspaceImagePhase_UNAVAILABLE WorkspaceImagePhase = 0
	WorkspaceImagePhase_AVAILABLE   WorkspaceImagePhase = 1
	WorkspaceImagePhase_BUILDING    WorkspaceImagePhase = 2
)

// Enum value maps for WorkspaceImagePhase.
var (
	WorkspaceImagePhase_name = map[int32]string{
		0: "UNAVAILABLE",
		1: "AVAILABLE",
		2: "BUILDING",
	}
	WorkspaceImagePhase_value = map[string]int32{
		"UNAVAILABLE": 0,
		"AVAILABLE":   1,
		"BUILDING":    2,
	}
...
func (x WorkspaceImagePhase) Enum() *WorkspaceImagePhase {
	p := new(WorkspaceImagePhase)
	*p = x
	return p
}

func (x WorkspaceImagePhase) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (WorkspaceImagePhase) Descriptor() protoreflect.EnumDescriptor {
	return file_core_proto_enumTypes[2].Descriptor()
}

func (WorkspaceImagePhase) Type() protoreflect.EnumType {
	return &file_core_proto_enumTypes[2]
}

func (x WorkspaceImagePhase) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use WorkspaceImagePhase.Descriptor instead.
func (WorkspaceImagePhase) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	// BuildingImage means the workspace currently has its workspace images built. Consult the image status
	// to find more details about this process.
	WorkspacePhase_BUILDING_IMAGE WorkspacePhase = 8
...
type WorkspaceStatus struct {
	...
	// WorkspaceImageStatus provides feedback about the workspace image that's used
	Image *WorkspaceImageStatus `protobuf:"bytes,11,opt,name=image,proto3" json:"image,omitempty"`
}
...
func (x *WorkspaceStatus) GetImage() *WorkspaceImageStatus {
	if x != nil {
		return x.Image
	}
	return nil
...
// WorkspaceImage configures the workspace image the workspace will use.
// Depending on the value, an image build may be neccessary.
type WorkspaceImage struct {
	...
	//	*WorkspaceImage_ImageRaw
	//	*WorkspaceImage_ImageRef
	//	*WorkspaceImage_FromFile
	Spec isWorkspaceImage_Spec `protobuf_oneof:"spec"`
}

func (x *WorkspaceImage) Reset() {
	*x = WorkspaceImage{}
	if protoimpl.UnsafeEnabled {
...
func (x *WorkspaceImage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WorkspaceImage) ProtoMessage() {}

func (x *WorkspaceImage) ProtoReflect() protoreflect.Message {
	mi := &file_core_proto_msgTypes[25]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WorkspaceImage.ProtoReflect.Descriptor instead.
func (*WorkspaceImage) Descriptor() ([]byte, []int) {
	return file_core_proto_rawDescGZIP(), []int{25}
}

func (m *WorkspaceImage) GetSpec() isWorkspaceImage_Spec {
	if m != nil {
		return m.Spec
	}
	return nil
...
func (x *WorkspaceImage) GetImageRaw() string {
	if x, ok := x.GetSpec().(*WorkspaceImage_ImageRaw); ok {
		return x.ImageRaw
	}
	return ""
}

func (x *WorkspaceImage) GetImageRef() string {
	if x, ok := x.GetSpec().(*WorkspaceImage_ImageRef); ok {
		return x.ImageRef
	}
	return ""
}

func (x *WorkspaceImage) GetFromFile() *WorkspaceImage_Dockerfile {
	if x, ok := x.GetSpec().(*WorkspaceImage_FromFile); ok {
		return x.FromFile
	}
	return nil
}

type isWorkspaceImage_Spec interface {
	isWorkspaceImage_Spec()
}

type WorkspaceImage_ImageRaw struct {
	// image_raw specifies an image reference that is used as is, i.e. won't be
	// resolved using image-builder and is not subject to a workspace image build.
	// USE WITH CAUTION - we'd expect only the image-builder to use this field.
	ImageRaw string `protobuf:"bytes,1,opt,name=image_raw,json=imageRaw,proto3,oneof"`
}

type WorkspaceImage_ImageRef struct {
	// image_ref specifies an image reference provided by the user. This image is
	// resolved to its digested form and may be subject to a workspace image build.
	ImageRef string `protobuf:"bytes,2,opt,name=image_ref,json=imageRef,proto3,oneof"`
}

type WorkspaceImage_FromFile struct {
	// from_file specifies a Dockerfile which ought to be built, relative to the
	// content initializer of the workspace.
	FromFile *WorkspaceImage_Dockerfile `protobuf:"bytes,3,opt,name=from_file,json=fromFile,proto3,oneof"`
}

func (*WorkspaceImage_ImageRaw) isWorkspaceImage_Spec() {}

func (*WorkspaceImage_ImageRef) isWorkspaceImage_Spec() {}

func (*WorkspaceImage_FromFile) isWorkspaceImage_Spec() {}
...
type WorkspaceImageStatus struct {
	...
	// phase covers the current phase of the workspace image
	Phase WorkspaceImagePhase `protobuf:"varint,1,opt,name=phase,proto3,enum=wsman.WorkspaceImagePhase" json:"phase,omitempty"`
	// base_image is the base workspace image. It's either the digest form
	// of an image reference, or the result of a prior image build.
	BaseImage string `protobuf:"bytes,2,opt,name=base_image,json=baseImage,proto3" json:"base_image,omitempty"`
	// workspace_image is the actual image used to run the workspace.
	WorkspaceImage string `protobuf:"bytes,3,opt,name=workspace_image,json=workspaceImage,proto3" json:"workspace_image,omitempty"`
	// When the phase is BUILDING, the log details point to the workspace logs
	Logs *WorkspaceImageStatus_LogDetails `protobuf:"bytes,4,opt,name=logs,proto3" json:"logs,omitempty"`
}

func (x *WorkspaceImageStatus) Reset() {
	*x = WorkspaceImageStatus{}
	if protoimpl.UnsafeEnabled {
...
func (x *WorkspaceImageStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WorkspaceImageStatus) ProtoMessage() {}

func (x *WorkspaceImageStatus) ProtoReflect() protoreflect.Message {
	mi := &file_core_proto_msgTypes[26]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WorkspaceImageStatus.ProtoReflect.Descriptor instead.
func (*WorkspaceImageStatus) Descriptor() ([]byte, []int) {
	return file_core_proto_rawDescGZIP(), []int{26}
}

func (x *WorkspaceImageStatus) GetPhase() WorkspaceImagePhase {
	if x != nil {
		return x.Phase
	}
	return WorkspaceImagePhase_UNAVAILABLE
}

func (x *WorkspaceImageStatus) GetBaseImage() string {
	if x != nil {
		return x.BaseImage
	}
	return ""
...
func (x *WorkspaceImageStatus) GetWorkspaceImage() string {
	if x != nil {
...
func (x *WorkspaceImageStatus) GetLogs() *WorkspaceImageStatus_LogDetails {
	if x != nil {
		return x.Logs
	}
	return nil
...
type WorkspaceSpec struct {
	...
	DeprecatedWorkspaceImage string `protobuf:"bytes,1,opt,name=deprecated_workspace_image,json=deprecatedWorkspaceImage,proto3" json:"deprecated_workspace_image,omitempty"`
	...
	// workspace_image specifies the workspace image
	WorkspaceImage *WorkspaceImage `protobuf:"bytes,9,opt,name=workspace_image,json=workspaceImage,proto3" json:"workspace_image,omitempty"`
}
...
func (x *WorkspaceSpec) GetDeprecatedWorkspaceImage() string {
	if x != nil {
		return x.DeprecatedWorkspaceImage
	}
	return ""
}
...
func (x *WorkspaceSpec) GetWorkspaceImage() *WorkspaceImage {
	if x != nil {
		return x.WorkspaceImage
	}
	return nil
...
type StartWorkspaceSpec struct {
	...
	// workspace_image specifies the workspace image
	WorkspaceImage *WorkspaceImage `protobuf:"bytes,13,opt,name=workspace_image,json=workspaceImage,proto3" json:"workspace_image,omitempty"`
}
...
func (x *StartWorkspaceSpec) GetDeprecatedWorkspaceImage() string {
	if x != nil {
		return x.DeprecatedWorkspaceImage
	}
	return ""
...
func (x *StartWorkspaceSpec) GetWorkspaceImage() *WorkspaceImage {
	if x != nil {
		return x.WorkspaceImage
	}
	return nil
...
type WorkspaceImage_Dockerfile struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *WorkspaceImage_Dockerfile) Reset() {
	*x = WorkspaceImage_Dockerfile{}
	if protoimpl.UnsafeEnabled {
...
func (x *WorkspaceImage_Dockerfile) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WorkspaceImage_Dockerfile) ProtoMessage() {}

func (x *WorkspaceImage_Dockerfile) ProtoReflect() protoreflect.Message {
	mi := &file_core_proto_msgTypes[39]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WorkspaceImage_Dockerfile.ProtoReflect.Descriptor instead.
func (*WorkspaceImage_Dockerfile) Descriptor() ([]byte, []int) {
	return file_core_proto_rawDescGZIP(), []int{25, 0}
}

func (x *WorkspaceImage_Dockerfile) GetPath() string {
	if x != nil {
		return x.Path
	}
	return ""
...
func (x *WorkspaceImage_Dockerfile) GetContext() string {
	if x != nil {
		return x.Context
	}
	return ""
...
type WorkspaceImageStatus_LogDetails struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *WorkspaceImageStatus_LogDetails) Reset() {
	*x = WorkspaceImageStatus_LogDetails{}
	if protoimpl.UnsafeEnabled {
...
func (x *WorkspaceImageStatus_LogDetails) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WorkspaceImageStatus_LogDetails) ProtoMessage() {}

func (x *WorkspaceImageStatus_LogDetails) ProtoReflect() protoreflect.Message {
	mi := &file_core_proto_msgTypes[40]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WorkspaceImageStatus_LogDetails.ProtoReflect.Descriptor instead.
func (*WorkspaceImageStatus_LogDetails) Descriptor() ([]byte, []int) {
	return file_core_proto_rawDescGZIP(), []int{26, 0}
}

func (x *WorkspaceImageStatus_LogDetails) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *WorkspaceImageStatus_LogDetails) GetHeader() map[string]string {
	if x != nil {
		return x.Header
	}
	return nil
...
func (*EnvironmentVariable_SecretKeyRef) Descriptor() ([]byte, []int) {
	return file_core_proto_rawDescGZIP(), []int{35, 0}
}
...
var file_core_proto_rawDesc = []byte{
	...
	,
	...
	0x63, 0x65, 0x53, 0x70, 0x65, 0x63, 0x52, 0x04, 0x73, 0x70, 0x65, 0x63, 0x12, 0x2b, 0x0a, 0x05,
	0x70, 0x68, 0x61, 0x73, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x15, 0x2e, 0x77, 0x73,
	0x6d, 0x61, 0x6e, 0x2e, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x50, 0x68, 0x61,
	0x73, 0x65, 0x52, 0x05, 0x70, 0x68, 0x61, 0x73, 0x65, 0x12, 0x3a, 0x0a, 0x0a, 0x63, 0x6f, 0x6e,
	0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x22, 0x67, 0x0a, 0x14, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x52, 0x75, 0x6e,
	0x74, 0x69, 0x6d, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1b, 0x0a, 0x09, 0x6e, 0x6f, 0x64, 0x65,
	...
	,
	...
	,
	...
	0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x22, 0x35, 0x0a, 0x0c, 0x45, 0x78, 0x70, 0x6f, 0x73, 0x65,
	0x64, 0x50, 0x6f, 0x72, 0x74, 0x73, 0x12, 0x25, 0x0a, 0x05, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x18,
	0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x77, 0x73, 0x6d, 0x61, 0x6e, 0x2e, 0x50, 0x6f,
	0x72, 0x74, 0x53, 0x70, 0x65, 0x63, 0x52, 0x05, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x2a, 0x34, 0x0a,
	...
	0x43, 0x0a, 0x13, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x49, 0x6d, 0x61, 0x67,
	0x65, 0x50, 0x68, 0x61, 0x73, 0x65, 0x12, 0x0f, 0x0a, 0x0b, 0x55, 0x4e, 0x41, 0x56, 0x41, 0x49,
	0x4c, 0x41, 0x42, 0x4c, 0x45, 0x10, 0x00, 0x12, 0x0d, 0x0a, 0x09, 0x41, 0x56, 0x41, 0x49, 0x4c,
	0x41, 0x42, 0x4c, 0x45, 0x10, 0x01, 0x12, 0x0c, 0x0a, 0x08, 0x42, 0x55, 0x49, 0x4c, 0x44, 0x49,
	0x4e, 0x47, 0x10, 0x02, 0x2a, 0x49, 0x0a, 0x0e, 0x50, 0x6f, 0x72, 0x74, 0x56, 0x69, 0x73, 0x69,
	...
	0x0a, 0x05, 0x45, 0x4d, 0x50, 0x54, 0x59, 0x10, 0x02, 0x2a, 0x97, 0x01, 0x0a, 0x0e, 0x57, 0x6f,
	...
	,
	...
	0x67, 0x69, 0x74, 0x70, 0x6f, 0x64, 0x2f, 0x77, 0x73, 0x2d, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65,
...
var file_core_proto_enumTypes = make([]protoimpl.EnumInfo, 8)
...
var file_core_proto_goTypes = []interface{}{
	...
	(WorkspaceImagePhase)(0),                 // 2: wsman.WorkspaceImagePhase
	(PortVisibility)(0),                      // 3: wsman.PortVisibility
	(WorkspaceConditionBool)(0),              // 4: wsman.WorkspaceConditionBool
	(WorkspacePhase)(0),                      // 5: wsman.WorkspacePhase
	(WorkspaceFeatureFlag)(0),                // 6: wsman.WorkspaceFeatureFlag
	(WorkspaceType)(0),                       // 7: wsman.WorkspaceType
	(*MetadataFilter)(nil),                   // 8: wsman.MetadataFilter
	(*GetWorkspacesRequest)(nil),             // 9: wsman.GetWorkspacesRequest
	(*GetWorkspacesResponse)(nil),            // 10: wsman.GetWorkspacesResponse
	(*StartWorkspaceRequest)(nil),            // 11: wsman.StartWorkspaceRequest
	(*StartWorkspaceResponse)(nil),           // 12: wsman.StartWorkspaceResponse
	(*StopWorkspaceRequest)(nil),             // 13: wsman.StopWorkspaceRequest
	(*StopWorkspaceResponse)(nil),            // 14: wsman.StopWorkspaceResponse
	(*DescribeWorkspaceRequest)(nil),         // 15: wsman.DescribeWorkspaceRequest
	(*DescribeWorkspaceResponse)(nil),        // 16: wsman.DescribeWorkspaceResponse
	(*SubscribeRequest)(nil),                 // 17: wsman.SubscribeRequest
	(*SubscribeResponse)(nil),                // 18: wsman.SubscribeResponse
	(*MarkActiveRequest)(nil),                // 19: wsman.MarkActiveRequest
	(*MarkActiveResponse)(nil),               // 20: wsman.MarkActiveResponse
	(*SetTimeoutRequest)(nil),                // 21: wsman.SetTimeoutRequest
	(*SetTimeoutResponse)(nil),               // 22: wsman.SetTimeoutResponse
	(*ControlPortRequest)(nil),               // 23: wsman.ControlPortRequest
	(*ControlPortResponse)(nil),              // 24: wsman.ControlPortResponse
	(*TakeSnapshotRequest)(nil),              // 25: wsman.TakeSnapshotRequest
	(*TakeSnapshotResponse)(nil),             // 26: wsman.TakeSnapshotResponse
	(*ControlAdmissionRequest)(nil),          // 27: wsman.ControlAdmissionRequest
	(*ControlAdmissionResponse)(nil),         // 28: wsman.ControlAdmissionResponse
	(*BackupWorkspaceRequest)(nil),           // 29: wsman.BackupWorkspaceRequest
	(*BackupWorkspaceResponse)(nil),          // 30: wsman.BackupWorkspaceResponse
	(*WorkspaceStatus)(nil),                  // 31: wsman.WorkspaceStatus
	(*IDEImage)(nil),                         // 32: wsman.IDEImage
	(*WorkspaceImage)(nil),                   // 33: wsman.WorkspaceImage
	(*WorkspaceImageStatus)(nil),             // 34: wsman.WorkspaceImageStatus
	(*WorkspaceSpec)(nil),                    // 35: wsman.WorkspaceSpec
	(*PortSpec)(nil),                         // 36: wsman.PortSpec
	(*WorkspaceConditions)(nil),              // 37: wsman.WorkspaceConditions
	(*WorkspaceMetadata)(nil),                // 38: wsman.WorkspaceMetadata
	(*WorkspaceRuntimeInfo)(nil),             // 39: wsman.WorkspaceRuntimeInfo
	(*WorkspaceAuthentication)(nil),          // 40: wsman.WorkspaceAuthentication
	(*StartWorkspaceSpec)(nil),               // 41: wsman.StartWorkspaceSpec
	(*GitSpec)(nil),                          // 42: wsman.GitSpec
	(*EnvironmentVariable)(nil),              // 43: wsman.EnvironmentVariable
	(*ExposedPorts)(nil),                     // 44: wsman.ExposedPorts
	nil,                                      // 45: wsman.MetadataFilter.AnnotationsEntry
	nil,                                      // 46: wsman.SubscribeResponse.HeaderEntry
	(*WorkspaceImage_Dockerfile)(nil),        // 47: wsman.WorkspaceImage.Dockerfile
	(*WorkspaceImageStatus_LogDetails)(nil),  // 48: wsman.WorkspaceImageStatus.LogDetails
	nil,                                      // 49: wsman.WorkspaceImageStatus.LogDetails.HeaderEntry
	nil,                                      // 50: wsman.WorkspaceMetadata.AnnotationsEntry
	(*EnvironmentVariable_SecretKeyRef)(nil), // 51: wsman.EnvironmentVariable.SecretKeyRef
	(*api.GitStatus)(nil),                    // 52: contentservice.GitStatus
	(*timestamppb.Timestamp)(nil),            // 53: google.protobuf.Timestamp
	(*api.WorkspaceInitializer)(nil),         // 54: contentservice.WorkspaceInitializer
}
var file_core_proto_depIdxs = []int32{
	45, // 0: wsman.MetadataFilter.annotations:type_name -> wsman.MetadataFilter.AnnotationsEntry
	8,  // 1: wsman.GetWorkspacesRequest.must_match:type_name -> wsman.MetadataFilter
	31, // 2: wsman.GetWorkspacesResponse.status:type_name -> wsman.WorkspaceStatus
	38, // 3: wsman.StartWorkspaceRequest.metadata:type_name -> wsman.WorkspaceMetadata
	41, // 4: wsman.StartWorkspaceRequest.spec:type_name -> wsman.StartWorkspaceSpec
	7,  // 5: wsman.StartWorkspaceRequest.type:type_name -> wsman.WorkspaceType
	0,  // 6: wsman.StopWorkspaceRequest.policy:type_name -> wsman.StopWorkspacePolicy
	31, // 7: wsman.DescribeWorkspaceResponse.status:type_name -> wsman.WorkspaceStatus
	8,  // 8: wsman.SubscribeRequest.must_match:type_name -> wsman.MetadataFilter
	31, // 9: wsman.SubscribeResponse.status:type_name -> wsman.WorkspaceStatus
	46, // 10: wsman.SubscribeResponse.header:type_name -> wsman.SubscribeResponse.HeaderEntry
	36, // 11: wsman.ControlPortRequest.spec:type_name -> wsman.PortSpec
	1,  // 12: wsman.ControlAdmissionRequest.level:type_name -> wsman.AdmissionLevel
	38, // 13: wsman.WorkspaceStatus.metadata:type_name -> wsman.WorkspaceMetadata
	35, // 14: wsman.WorkspaceStatus.spec:type_name -> wsman.WorkspaceSpec
	5,  // 15: wsman.WorkspaceStatus.phase:type_name -> wsman.WorkspacePhase
	37, // 16: wsman.WorkspaceStatus.conditions:type_name -> wsman.WorkspaceConditions
	52, // 17: wsman.WorkspaceStatus.repo:type_name -> contentservice.GitStatus
	39, // 18: wsman.WorkspaceStatus.runtime:type_name -> wsman.WorkspaceRuntimeInfo
	40, // 19: wsman.WorkspaceStatus.auth:type_name -> wsman.WorkspaceAuthentication
	34, // 20: wsman.WorkspaceStatus.image:type_name -> wsman.WorkspaceImageStatus
	47, // 21: wsman.WorkspaceImage.from_file:type_name -> wsman.WorkspaceImage.Dockerfile
	2,  // 22: wsman.WorkspaceImageStatus.phase:type_name -> wsman.WorkspaceImagePhase
	48, // 23: wsman.WorkspaceImageStatus.logs:type_name -> wsman.WorkspaceImageStatus.LogDetails
	36, // 24: wsman.WorkspaceSpec.exposed_ports:type_name -> wsman.PortSpec
	7,  // 25: wsman.WorkspaceSpec.type:type_name -> wsman.WorkspaceType
	32, // 26: wsman.WorkspaceSpec.ide_image:type_name -> wsman.IDEImage
	33, // 27: wsman.WorkspaceSpec.workspace_image:type_name -> wsman.WorkspaceImage
	3,  // 28: wsman.PortSpec.visibility:type_name -> wsman.PortVisibility
	4,  // 29: wsman.WorkspaceConditions.pulling_images:type_name -> wsman.WorkspaceConditionBool
	4,  // 30: wsman.WorkspaceConditions.final_backup_complete:type_name -> wsman.WorkspaceConditionBool
	4,  // 31: wsman.WorkspaceConditions.deployed:type_name -> wsman.WorkspaceConditionBool
	4,  // 32: wsman.WorkspaceConditions.network_not_ready:type_name -> wsman.WorkspaceConditionBool
	53, // 33: wsman.WorkspaceConditions.first_user_activity:type_name -> google.protobuf.Timestamp
	4,  // 34: wsman.WorkspaceConditions.stopped_by_request:type_name -> wsman.WorkspaceConditionBool
	53, // 35: wsman.WorkspaceMetadata.started_at:type_name -> google.protobuf.Timestamp
	50, // 36: wsman.WorkspaceMetadata.annotations:type_name -> wsman.WorkspaceMetadata.AnnotationsEntry
	1,  // 37: wsman.WorkspaceAuthentication.admission:type_name -> wsman.AdmissionLevel
	6,  // 38: wsman.StartWorkspaceSpec.feature_flags:type_name -> wsman.WorkspaceFeatureFlag
	54, // 39: wsman.StartWorkspaceSpec.initializer:type_name -> contentservice.WorkspaceInitializer
	36, // 40: wsman.StartWorkspaceSpec.ports:type_name -> wsman.PortSpec
	43, // 41: wsman.StartWorkspaceSpec.envvars:type_name -> wsman.EnvironmentVariable
	42, // 42: wsman.StartWorkspaceSpec.git:type_name -> wsman.GitSpec
	1,  // 43: wsman.StartWorkspaceSpec.admission:type_name -> wsman.AdmissionLevel
	32, // 44: wsman.StartWorkspaceSpec.ide_image:type_name -> wsman.IDEImage
	33, // 45: wsman.StartWorkspaceSpec.workspace_image:type_name -> wsman.WorkspaceImage
	51, // 46: wsman.EnvironmentVariable.secret:type_name -> wsman.EnvironmentVariable.SecretKeyRef
	36, // 47: wsman.ExposedPorts.ports:type_name -> wsman.PortSpec
	49, // 48: wsman.WorkspaceImageStatus.LogDetails.header:type_name -> wsman.WorkspaceImageStatus.LogDetails.HeaderEntry
	9,  // 49: wsman.WorkspaceManager.GetWorkspaces:input_type -> wsman.GetWorkspacesRequest
	11, // 50: wsman.WorkspaceManager.StartWorkspace:input_type -> wsman.StartWorkspaceRequest
	13, // 51: wsman.WorkspaceManager.StopWorkspace:input_type -> wsman.StopWorkspaceRequest
	15, // 52: wsman.WorkspaceManager.DescribeWorkspace:input_type -> wsman.DescribeWorkspaceRequest
	29, // 53: wsman.WorkspaceManager.BackupWorkspace:input_type -> wsman.BackupWorkspaceRequest
	17, // 54: wsman.WorkspaceManager.Subscribe:input_type -> wsman.SubscribeRequest
	19, // 55: wsman.WorkspaceManager.MarkActive:input_type -> wsman.MarkActiveRequest
	21, // 56: wsman.WorkspaceManager.SetTimeout:input_type -> wsman.SetTimeoutRequest
	23, // 57: wsman.WorkspaceManager.ControlPort:input_type -> wsman.ControlPortRequest
	25, // 58: wsman.WorkspaceManager.TakeSnapshot:input_type -> wsman.TakeSnapshotRequest
	27, // 59: wsman.WorkspaceManager.ControlAdmission:input_type -> wsman.ControlAdmissionRequest
	10, // 60: wsman.WorkspaceManager.GetWorkspaces:output_type -> wsman.GetWorkspacesResponse
	12, // 61: wsman.WorkspaceManager.StartWorkspace:output_type -> wsman.StartWorkspaceResponse
	14, // 62: wsman.WorkspaceManager.StopWorkspace:output_type -> wsman.StopWorkspaceResponse
	16, // 63: wsman.WorkspaceManager.DescribeWorkspace:output_type -> wsman.DescribeWorkspaceResponse
	30, // 64: wsman.WorkspaceManager.BackupWorkspace:output_type -> wsman.BackupWorkspaceResponse
	18, // 65: wsman.WorkspaceManager.Subscribe:output_type -> wsman.SubscribeResponse
	20, // 66: wsman.WorkspaceManager.MarkActive:output_type -> wsman.MarkActiveResponse
	22, // 67: wsman.WorkspaceManager.SetTimeout:output_type -> wsman.SetTimeoutResponse
	24, // 68: wsman.WorkspaceManager.ControlPort:output_type -> wsman.ControlPortResponse
	26, // 69: wsman.WorkspaceManager.TakeSnapshot:output_type -> wsman.TakeSnapshotResponse
	28, // 70: wsman.WorkspaceManager.ControlAdmission:output_type -> wsman.ControlAdmissionResponse
...
func file_core_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_core_proto_msgTypes[26].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WorkspaceImageStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_core_proto_msgTypes[39].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WorkspaceImage_Dockerfile); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_core_proto_msgTypes[40].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WorkspaceImageStatus_LogDetails); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_core_proto_msgTypes[25].OneofWrappers = []interface{}{
		(*WorkspaceImage_ImageRaw)(nil),
		(*WorkspaceImage_ImageRef)(nil),
		(*WorkspaceImage_FromFile)(nil),
	}
	type x struct{}
