...
var file_core_proto_rawDesc = []byte{
	...
	0x03, 0x10, 0x03, 0x32, 0x93, 0x08, 0x0a, 0x10, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63,
...
var file_core_proto_msgTypes = make([]protoimpl.MessageInfo, 45)
var file_core_proto_goTypes = []interface{}{
	...
	nil,                                      // 48: wsman.MetadataFilter.AnnotationsEntry
	nil,                                      // 49: wsman.SubscribeResponse.HeaderEntry
...
var file_core_proto_depIdxs = []int32{
	48, // 0: wsman.MetadataFilter.annotations:type_name -> wsman.MetadataFilter.AnnotationsEntry
	...
	49, // 10: wsman.SubscribeResponse.header:type_name -> wsman.SubscribeResponse.HeaderEntry
	...
	53, // 28: wsman.WorkspaceConditions.first_user_activity:type_name -> google.protobuf.Timestamp
	...
	53, // 31: wsman.WorkspaceMetadata.started_at:type_name -> google.protobuf.Timestamp
	50, // 32: wsman.WorkspaceMetadata.annotations:type_name -> wsman.WorkspaceMetadata.AnnotationsEntry
	...
	54, // 35: wsman.StartWorkspaceSpec.initializer:type_name -> contentservice.WorkspaceInitializer
	...
	51, // 42: wsman.EnvironmentVariable.secret:type_name -> wsman.EnvironmentVariable.SecretKeyRef
	...
	32, // 56: wsman.WorkspaceManager.UpdateSSHKey:input_type -> wsman.UpdateSSHKeyRequest
	9,  // 57: wsman.WorkspaceManager.GetWorkspaces:output_type -> wsman.GetWorkspacesResponse
	11, // 58: wsman.WorkspaceManager.StartWorkspace:output_type -> wsman.StartWorkspaceResponse
	13, // 59: wsman.WorkspaceManager.StopWorkspace:output_type -> wsman.StopWorkspaceResponse
	15, // 60: wsman.WorkspaceManager.DescribeWorkspace:output_type -> wsman.DescribeWorkspaceResponse
	31, // 61: wsman.WorkspaceManager.BackupWorkspace:output_type -> wsman.BackupWorkspaceResponse
	17, // 62: wsman.WorkspaceManager.Subscribe:output_type -> wsman.SubscribeResponse
	19, // 63: wsman.WorkspaceManager.MarkActive:output_type -> wsman.MarkActiveResponse
	21, // 64: wsman.WorkspaceManager.SetTimeout:output_type -> wsman.SetTimeoutResponse
	23, // 65: wsman.WorkspaceManager.ControlPort:output_type -> wsman.ControlPortResponse
	25, // 66: wsman.WorkspaceManager.TakeSnapshot:output_type -> wsman.TakeSnapshotResponse
	27, // 67: wsman.WorkspaceManager.ControlAdmission:output_type -> wsman.ControlAdmissionResponse
	29, // 68: wsman.WorkspaceManager.DeleteVolumeSnapshot:output_type -> wsman.DeleteVolumeSnapshotResponse
	33, // 69: wsman.WorkspaceManager.UpdateSSHKey:output_type -> wsman.UpdateSSHKeyResponse
