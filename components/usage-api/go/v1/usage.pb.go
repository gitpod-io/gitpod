...
type GetBilledUsageRequest struct {
...
func (x *GetBilledUsageRequest) Reset() {
	*x = GetBilledUsageRequest{}
...
func (x *GetBilledUsageRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetBilledUsageRequest) ProtoMessage() {}

func (x *GetBilledUsageRequest) ProtoReflect() protoreflect.Message {
	mi := &file_usage_v1_usage_proto_msgTypes[0]
...
// Deprecated: Use GetBilledUsageRequest.ProtoReflect.Descriptor instead.
func (*GetBilledUsageRequest) Descriptor() ([]byte, []int) {
	return file_usage_v1_usage_proto_rawDescGZIP(), []int{0}
}

func (x *GetBilledUsageRequest) GetAttributionId() string {
	if x != nil {
...
type GetBilledUsageResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetBilledUsageResponse) Reset() {
	*x = GetBilledUsageResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetBilledUsageResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetBilledUsageResponse) ProtoMessage() {}

func (x *GetBilledUsageResponse) ProtoReflect() protoreflect.Message {
	mi := &file_usage_v1_usage_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetBilledUsageResponse.ProtoReflect.Descriptor instead.
func (*GetBilledUsageResponse) Descriptor() ([]byte, []int) {
	return file_usage_v1_usage_proto_rawDescGZIP(), []int{1}
}

func (x *GetBilledUsageResponse) GetSessions() []*BilledSession {
	if x != nil {
		return x.Sessions
	}
	return nil
...
var file_usage_v1_usage_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x3e, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x42, 0x69, 0x6c, 0x6c, 0x65, 0x64, 0x55, 0x73,
	0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x25, 0x0a, 0x0e, 0x61, 0x74,
	...
	0x64, 0x22, 0x4d, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x42, 0x69, 0x6c, 0x6c, 0x65, 0x64, 0x55, 0x73,
	...
	0x22, 0xa7, 0x03, 0x0a, 0x0d, 0x42, 0x69, 0x6c, 0x6c, 0x65, 0x64, 0x53, 0x65, 0x73, 0x73, 0x69,
	...
	,
...
var file_usage_v1_usage_proto_goTypes = []interface{}{
	(*GetBilledUsageRequest)(nil),  // 0: usage.v1.GetBilledUsageRequest
	(*GetBilledUsageResponse)(nil), // 1: usage.v1.GetBilledUsageResponse
	(*BilledSession)(nil),          // 2: usage.v1.BilledSession
	(*timestamppb.Timestamp)(nil),  // 3: google.protobuf.Timestamp
}
var file_usage_v1_usage_proto_depIdxs = []int32{
	2, // 0: usage.v1.GetBilledUsageResponse.sessions:type_name -> usage.v1.BilledSession
	3, // 1: usage.v1.BilledSession.start_time:type_name -> google.protobuf.Timestamp
	3, // 2: usage.v1.BilledSession.end_time:type_name -> google.protobuf.Timestamp
	0, // 3: usage.v1.UsageService.GetBilledUsage:input_type -> usage.v1.GetBilledUsageRequest
	1, // 4: usage.v1.UsageService.GetBilledUsage:output_type -> usage.v1.GetBilledUsageResponse
...
func file_usage_v1_usage_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_usage_v1_usage_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetBilledUsageRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_usage_v1_usage_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetBilledUsageResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
