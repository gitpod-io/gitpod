...
var file_usage_v1_usage_proto_depIdxs = []int32{
	...
	16, // 11: usage.v1.GetCostCenterResponse.cost_center:type_name -> usage.v1.CostCenter
	2,  // 12: usage.v1.CostCenter.billing_strategy:type_name -> usage.v1.CostCenter.BillingStrategy
	17, // 13: usage.v1.CostCenter.next_billing_time:type_name -> google.protobuf.Timestamp
	...
	12, // 18: usage.v1.UsageService.GetBalance:input_type -> usage.v1.GetBalanceRequest
	15, // 19: usage.v1.UsageService.GetCostCenter:output_type -> usage.v1.GetCostCenterResponse
	11, // 20: usage.v1.UsageService.SetCostCenter:output_type -> usage.v1.SetCostCenterResponse
	4,  // 21: usage.v1.UsageService.ReconcileUsage:output_type -> usage.v1.ReconcileUsageResponse
	8,  // 22: usage.v1.UsageService.ListUsage:output_type -> usage.v1.ListUsageResponse
	13, // 23: usage.v1.UsageService.GetBalance:output_type -> usage.v1.GetBalanceResponse
