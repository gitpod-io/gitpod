...
var file_usage_v1_usage_proto_rawDesc = []byte{
	...
	0x59, 0x5f, 0x4f, 0x54, 0x48, 0x45, 0x52, 0x10, 0x01, 0x22, 0x13, 0x0a, 0x11, 0x52, 0x65, 0x73,
	0x65, 0x74, 0x55, 0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x14,
	0x0a, 0x12, 0x52, 0x65, 0x73, 0x65, 0x74, 0x55, 0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x32, 0xeb, 0x03, 0x0a, 0x0c, 0x55, 0x73, 0x61, 0x67, 0x65, 0x53, 0x65,
...
var file_usage_v1_usage_proto_depIdxs = []int32{
	...
	14, // 15: usage.v1.UsageService.GetCostCenter:input_type -> usage.v1.GetCostCenterRequest
	10, // 16: usage.v1.UsageService.SetCostCenter:input_type -> usage.v1.SetCostCenterRequest
	3,  // 17: usage.v1.UsageService.ReconcileUsage:input_type -> usage.v1.ReconcileUsageRequest
	17, // 18: usage.v1.UsageService.ResetUsage:input_type -> usage.v1.ResetUsageRequest
	7,  // 19: usage.v1.UsageService.ListUsage:input_type -> usage.v1.ListUsageRequest
	12, // 20: usage.v1.UsageService.GetBalance:input_type -> usage.v1.GetBalanceRequest
	15, // 21: usage.v1.UsageService.GetCostCenter:output_type -> usage.v1.GetCostCenterResponse
	11, // 22: usage.v1.UsageService.SetCostCenter:output_type -> usage.v1.SetCostCenterResponse
	4,  // 23: usage.v1.UsageService.ReconcileUsage:output_type -> usage.v1.ReconcileUsageResponse
	18, // 24: usage.v1.UsageService.ResetUsage:output_type -> usage.v1.ResetUsageResponse
	8,  // 25: usage.v1.UsageService.ListUsage:output_type -> usage.v1.ListUsageResponse
	13, // 26: usage.v1.UsageService.GetBalance:output_type -> usage.v1.GetBalanceResponse
