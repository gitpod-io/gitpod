# Gitpod Individual Contributor License Agreement

Thank you for your interest in contributing to Gitpod ("We" or "Us").
...
following the instructions at http://www.gitpod.io. This is a legally binding document, so please read
it carefully before agreeing to it. The Agreement may cover more than one software project managed
by Us.
...
- "Contribution" means any work of authorship that is Submitted by You to Us in which You own or assert ownership of the Copyright. If You do not own the Copyright in the entire work of authorship, please follow the instructions in http://www.gitpod.io/cla.
...
(d) You have followed the instructions in http://www.gitpod.io/cla, if You do not own the Copyright in the entire work of authorship Submitted.
