		...
		IDEOptions: IDEOptions{
			Options: map[string]IDEOption{
				...
				"intellij-eap": {
					...
					Type:     typeDesktop,
					Logo:     "intellij-idea",
					Tooltip:  pointer.String("Latest IntelliJ IDEA, includes Early-Access-Programm (EAP)"),
					Label:    pointer.String("EAP"),
					Notes:    []string{"While in beta, when you open a workspace with IntelliJ IDEA you will need to use the password “gitpod”."},
					Image:    common.ImageName(ctx.Config.Repository, workspace.IntelliJEAPDesktopIDEImage, ctx.VersionManifest.Components.Workspace.DesktopIdeImages.IntelliJEAPImage.Version),
				},
				"goland": {
				...
				"goland-eap": {
					...
					Type:     typeDesktop,
					Logo:     "goland",
					Tooltip:  pointer.String("Latest GoLand, includes Early-Access-Programm (EAP)"),
					Label:    pointer.String("EAP"),
					Notes:    []string{"While in beta, when you open a workspace with GoLand you will need to use the password “gitpod”."},
					Image:    common.ImageName(ctx.Config.Repository, workspace.GoLandEAPDesktopIdeImage, ctx.VersionManifest.Components.Workspace.DesktopIdeImages.GoLandEAPImage.Version),
				},
			},
			DefaultIDE:        "code",
