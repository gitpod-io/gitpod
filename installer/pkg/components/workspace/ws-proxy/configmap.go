	...
	wspcfg := config.Config{
		...
		Proxy: proxy.Config{
			...
			WorkspacePodConfig: &proxy.WorkspacePodConfig{
				TheiaPort:       WorkspaceContainerPort,
				SupervisorPort:  WorkspaceSupervisorPort,
				SupervisorImage: common.ImageName(ctx.Config.Repository, ide.SupervisorImage, ctx.VersionManifest.Components.Workspace.Supervisor.Version),
			},
